...
static mtcName stfNotEqualsFunctionName[1] = {
    { NULL, 9, (void*)"NOTEQUALS" } // Fix BUG-15505
};

static IDE_RC stfNotEqualsEstimate(
                        mtcNode*     aNode,
...
mtfModule stfNotEquals = {
    1|MTC_NODE_OPERATOR_EQUAL|MTC_NODE_COMPARISON_TRUE,
    ~(MTC_NODE_INDEX_MASK),
    1.0/2.0,  // TODO : default selectivity 
    stfNotEqualsFunctionName,
    &stfEquals,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfNotEqualsEstimate
};

IDE_RC stfNotEqualsCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfNotEqualsEstimate( mtcNode*     aNode,
                             mtcTemplate* aTemplate,
                             mtcStack*    aStack,
                             SInt      /* aRemain */,
                             mtcCallBack* aCallBack )
