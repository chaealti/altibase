...
static mtcName stfNumGeometriesFunctionName[2] = {
    { stfNumGeometriesFunctionName+1, 16, (void*)"ST_NUMGEOMETRIES" }, // Fix BUG-15519
    { NULL, 13, (void*)"NUMGEOMETRIES" }
};

static IDE_RC stfNumGeometriesEstimate(
                        mtcNode*     aNode,
...
mtfModule stfNumGeometries = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfNumGeometriesFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfNumGeometriesEstimate
};

IDE_RC stfNumGeometriesCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfNumGeometriesEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::numGeometries( aNode,
                                           aStack,
                                           aRemain,
                                           aInfo,
