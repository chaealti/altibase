...
static mtcName stfDimensionFunctionName[2] = {
    { stfDimensionFunctionName+1, 12, (void*)"ST_DIMENSION" }, // Fix BUG-15519
    { NULL, 9, (void*)"DIMENSION" }
};

static IDE_RC stfDimensionEstimate(
                        mtcNode*     aNode,
...
mtfModule stfDimension = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfDimensionFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfDimensionEstimate
};

IDE_RC stfDimensionCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfDimensionEstimate( mtcNode*     aNode,
                             mtcTemplate* aTemplate,
                             mtcStack*    aStack,
                             SInt      /* aRemain */,
                             mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfBasic::dimension(  aNode,
                                    aStack,
                                    aRemain,
                                    aInfo,
