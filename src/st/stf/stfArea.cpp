...
static mtcName stfAreaFunctionName[2] = {
    { stfAreaFunctionName+1, 7, (void*)"ST_AREA" }, // Fix BUG-15519
    { NULL, 4, (void*)"AREA" }
};

static IDE_RC stfAreaEstimate( mtcNode*     aNode,
...
IDE_RC stfAreaCalculate( mtcNode*     aNode,
                         mtcStack*    aStack,
                         SInt         aRemain,
                         void*        aInfo,
                         mtcTemplate* aTemplate );
...
IDE_RC stfAreaEstimate( mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::area( aNode,
                                  aStack,
                                  aRemain,
                                  aInfo,
