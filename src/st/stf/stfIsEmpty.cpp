...
static mtcName stfIsEmptyFunctionName[2] = {
    { stfIsEmptyFunctionName+1, 10, (void*)"ST_ISEMPTY" }, // Fix BUG-15519
    { NULL, 7, (void*)"ISEMPTY" }
};

static IDE_RC stfIsEmptyEstimate(
                        mtcNode*     aNode,
...
mtfModule stfIsEmpty = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfIsEmptyFunctionName,
    NULL,
...
IDE_RC stfIsEmptyEstimate( mtcNode*     aNode,
                           mtcTemplate* aTemplate,
                           mtcStack*    aStack,
                           SInt      /* aRemain */,
                           mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfBasic::isEmpty( aNode,
                                 aStack,
                                 aRemain,
                                 aInfo,
