...
static mtcName stfSymDifferenceFunctionName[2] = {
    { stfSymDifferenceFunctionName+1, 16, (void*)"ST_SYMDIFFERENCE" }, // Fix BUG-15519
    { NULL, 13, (void*)"SYMDIFFERENCE" }
};

static IDE_RC stfSymDifferenceEstimate(
                        mtcNode*     aNode,
...
mtfModule stfSymDifference = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfSymDifferenceFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfSymDifferenceEstimate
};

IDE_RC stfSymDifferenceCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfSymDifferenceEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfAnalysis::symDifference( aNode,
                                          aStack,
                                          aRemain,
                                          aInfo,
