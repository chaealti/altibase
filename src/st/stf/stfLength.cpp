...
static mtcName stfLengthFunctionName[2] = {
    { stfLengthFunctionName+1, 9, (void*)"ST_LENGTH" }, // Fix BUG-15519
    { NULL, 14, (void*)"GEOMETRYLENGTH" }// Fix BUG-16097
};

static IDE_RC stfLengthEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfLengthEstimate( mtcNode*     aNode,
                          mtcTemplate* aTemplate,
                          mtcStack*    aStack,
                          SInt      /* aRemain */,
                          mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::length( aNode,
                                    aStack,
                                    aRemain,
                                    aInfo,
