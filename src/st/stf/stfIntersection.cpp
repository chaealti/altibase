...
static mtcName stfIntersectionFunctionName[2] = {
    { stfIntersectionFunctionName+1, 15, (void*)"ST_INTERSECTION" }, // Fix BUG-15519
    { NULL, 12, (void*)"INTERSECTION" }
};

static IDE_RC stfIntersectionEstimate(
                        mtcNode*     aNode,
...
mtfModule stfIntersection = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfIntersectionFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfIntersectionEstimate
};

IDE_RC stfIntersectionCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfIntersectionEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfAnalysis::intersection( aNode,
                                         aStack,
                                         aRemain,
                                         aInfo,
