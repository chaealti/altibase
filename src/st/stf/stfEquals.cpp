...
static mtcName stfEqualsFunctionName[2] = {
    { stfEqualsFunctionName+1, 9, (void*)"ST_EQUALS" }, // Fix BUG-15519
    { NULL, 6, (void*)"EQUALS" }
};

static IDE_RC stfEqualsEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfEqualsExtractRange(
                        mtcNode*      aNode,
                        mtcTemplate*  aTemplate,
                        mtkRangeInfo* aInfo,
                        smiRange*     aRange );

IDE_RC stfEqualsCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
static const mtcExecute stfExecute = {
    ...
    NULL,
    mtx::calculateNA,
    stfEqualsEstimateRange,
    stfEqualsExtractRange
};

IDE_RC stfEqualsEstimate( mtcNode*     aNode,
                          mtcTemplate* aTemplate,
                          mtcStack*    aStack,
                          SInt      /* aRemain */,
                          mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfRelation::isEquals( aNode,
                                     aStack,
                                     aRemain,
                                     aInfo,
