...
static mtcName stfNotWithinFunctionName[1] = {
    { NULL, 9, (void*)"NOTWITHIN" } // Fix BUG-15505
};

static IDE_RC stfNotWithinEstimate(
                        mtcNode*     aNode,
...
mtfModule stfNotWithin = {
    1|MTC_NODE_OPERATOR_EQUAL|MTC_NODE_COMPARISON_TRUE,
    ~(MTC_NODE_INDEX_MASK),
    1.0/2.0,  // TODO : default selectivity 
    stfNotWithinFunctionName,
    &stfWithin,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfNotWithinEstimate
};

IDE_RC stfNotWithinCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfNotWithinEstimate( mtcNode*     aNode,
                             mtcTemplate* aTemplate,
                             mtcStack*    aStack,
                             SInt      /* aRemain */,
                             mtcCallBack* aCallBack )
