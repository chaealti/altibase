...
static mtcName stfIsRingFunctionName[2] = {
    { stfIsRingFunctionName+1, 9, (void*)"ST_ISRING" }, // Fix BUG-15519
    { NULL, 6, (void*)"ISRING" }
};

static IDE_RC stfIsRingEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfIsRingEstimate( mtcNode*     aNode,
                          mtcTemplate* aTemplate,
                          mtcStack*    aStack,
                          SInt      /* aRemain */,
                          mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::isRing( aNode,
                                    aStack,
                                    aRemain,
                                    aInfo,
