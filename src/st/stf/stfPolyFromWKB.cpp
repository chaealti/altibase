...
static mtcName stfPolyFromWKBFunctionName[2] = {
    { stfPolyFromWKBFunctionName+1, 14, (void*)"ST_POLYFROMWKB" },
    { NULL, 11, (void*)"POLYFROMWKB" }
};

static IDE_RC stfPolyFromWKBEstimate(
                        mtcNode*     aNode,
...
mtfModule stfPolyFromWKB = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfPolyFromWKBFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfPolyFromWKBEstimate
};

IDE_RC stfPolyFromWKBCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfPolyFromWKBEstimate( mtcNode*     aNode,
                               mtcTemplate* aTemplate,
                               mtcStack*    aStack,
                               SInt      /* aRemain */,
                               mtcCallBack* aCallBack )
