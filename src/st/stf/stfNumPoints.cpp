...
static mtcName stfNumPointsFunctionName[2] = {
    { stfNumPointsFunctionName+1, 12, (void*)"ST_NUMPOINTS" }, // Fix BUG-15519
    { NULL, 9, (void*)"NUMPOINTS" }
};

static IDE_RC stfNumPointsEstimate(
                        mtcNode*     aNode,
...
mtfModule stfNumPoints = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfNumPointsFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfNumPointsEstimate
};

IDE_RC stfNumPointsCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfNumPointsEstimate( mtcNode*     aNode,
                             mtcTemplate* aTemplate,
                             mtcStack*    aStack,
                             SInt      /* aRemain */,
                             mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::numPoints( aNode,
                                       aStack,
                                       aRemain,
                                       aInfo,
