...
static mtcName stfIsMBRWithinFunctionName[3] = {
    { stfIsMBRWithinFunctionName+1, 14, (void*)"ST_ISMBRWITHIN" }, 
    { stfIsMBRWithinFunctionName+2, 11, (void*)"ISMBRWITHIN" },
    { NULL, 11, (void*)"ISMBBWITHIN" }
};

static IDE_RC stfIsMBRWithinEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfIsMBRWithinEstimateRange(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        UInt         aArgument,
                        UInt*        aSize );

mtfModule stfIsMBRWithin = {
    ...
    stfIsMBRWithinFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfIsMBRWithinEstimate
};


IDE_RC stfIsMBRWithinExtractRange( 
                        mtcNode*      aNode,
                        mtcTemplate*  aTemplate,
                        mtkRangeInfo* aInfo,
                        smiRange*     aRange );

IDE_RC stfIsMBRWithinCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
static const mtcExecute stfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    stfIsMBRWithinCalculate,
    NULL,
    mtx::calculateNA,
    stfIsMBRWithinEstimateRange,
    stfIsMBRWithinExtractRange
};

IDE_RC stfIsMBRWithinEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
...
/***********************************************************************
 * Description:
 * 두 Geometry 객체의 관계가 MBR Within 인지 판별
 *
