...
static mtcName stfLineFromTextFunctionName[2] = {
    { stfLineFromTextFunctionName+1, 15, (void*)"ST_LINEFROMTEXT" },
    { NULL, 12, (void*)"LINEFROMTEXT" }
};

static IDE_RC stfLineFromTextEstimate(
                        mtcNode*     aNode,
...
mtfModule stfLineFromText = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfLineFromTextFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfLineFromTextEstimate
};

IDE_RC stfLineFromTextCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfLineFromTextEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    else
    {
        ...
        IDE_TEST( stfWKT::lineFromText( sQmxMem,
                                        aStack[1].value,
                                        aStack[0].value,
