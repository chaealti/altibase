...
static mtcName stfPointNFunctionName[2] = {
    { stfPointNFunctionName+1, 9, (void*)"ST_POINTN" }, // Fix BUG-15519
    { NULL, 6, (void*)"POINTN" }
};

static IDE_RC stfPointNEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfPointNEstimate( mtcNode*     aNode,
                          mtcTemplate* aTemplate,
                          mtcStack*    aStack,
                          SInt      /* aRemain */,
                          mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::pointN( aNode,
                                    aStack,
                                    aRemain,
                                    aInfo,
