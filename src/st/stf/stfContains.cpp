...
static mtcName stfContainsFunctionName[2] = {
    { stfContainsFunctionName+1, 11, (void*)"ST_CONTAINS" }, // Fix BUG-15519
    { NULL, 8, (void*)"CONTAINS" }
};

static IDE_RC stfContainsEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfContainsEstimateRange(
                        mtcNode*,
                        mtcTemplate*,
                        UInt,
                        UInt*    aSize );

mtfModule stfContains = {
...
IDE_RC stfExtractRange( 
                        mtcNode*      aNode,
                        mtcTemplate*  aTemplate,
                        mtkRangeInfo* aInfo,
                        smiRange*     aRange );

IDE_RC stfContainsCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
static const mtcExecute stfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    stfContainsCalculate,
    NULL,
    mtx::calculateNA,
    stfContainsEstimateRange,
    stfExtractRange
};

IDE_RC stfContainsEstimate( mtcNode*     aNode,
                            mtcTemplate* aTemplate,
                            mtcStack*    aStack,
                            SInt      /* aRemain */,
                            mtcCallBack* aCallBack )
