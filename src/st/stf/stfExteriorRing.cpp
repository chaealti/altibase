...
static mtcName stfExteriorRingFunctionName[2] = {
    { stfExteriorRingFunctionName+1, 15, (void*)"ST_EXTERIORRING" }, // Fix BUG-15519
    { NULL, 12, (void*)"EXTERIORRING" }
};

static IDE_RC stfExteriorRingEstimate(
                        mtcNode*     aNode,
...
mtfModule stfExteriorRing = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfExteriorRingFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfExteriorRingEstimate
};

IDE_RC stfExteriorRingCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfExteriorRingEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::exteriorRing( aNode,
                                          aStack,
                                          aRemain,
                                          aInfo,
