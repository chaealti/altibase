...
static mtcName stfMinYFunctionName[3] = {
    { stfMinYFunctionName+1, 7, (void*)"ST_MINY" }, 
    { NULL,                  4, (void*)"MINY" }
};

static IDE_RC stfMinYEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfMinYEstimate( mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        mtcCallBack* aCallBack )
