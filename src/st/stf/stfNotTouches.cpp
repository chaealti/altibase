...
static mtcName stfNotTouchesFunctionName[1] = {
    { NULL, 10, (void*)"NOTTOUCHES" }   // Fix BUG-15505
};

static IDE_RC stfNotTouchesEstimate(
                        mtcNode*     aNode,
...
mtfModule stfNotTouches = {
    1|MTC_NODE_OPERATOR_EQUAL|MTC_NODE_COMPARISON_TRUE,
    ~(MTC_NODE_INDEX_MASK),
    1.0/2.0,  // TODO : default selectivity 
    stfNotTouchesFunctionName,
    &stfTouches,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfNotTouchesEstimate
};

IDE_RC stfNotTouchesCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfNotTouchesEstimate( mtcNode*     aNode,
                              mtcTemplate* aTemplate,
                              mtcStack*    aStack,
                              SInt      /* aRemain */,
                              mtcCallBack* aCallBack )
