...
static mtcName stfMLineFromWKBFunctionName[2] = {
    { stfMLineFromWKBFunctionName+1, 15, (void*)"ST_GEOMFROMWKB" },
    { NULL, 12, (void*)"MLINEFROMWKB" }
};

static IDE_RC stfMLineFromWKBEstimate(
                        mtcNode*     aNode,
...
mtfModule stfMLineFromWKB = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfMLineFromWKBFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfMLineFromWKBEstimate
};

IDE_RC stfMLineFromWKBCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfMLineFromWKBEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
