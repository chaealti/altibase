...
static mtcName stfBufferFunctionName[2] = {
    { stfBufferFunctionName+1, 9, (void*)"ST_BUFFER" }, // Fix BUG-15519
    { NULL, 6, (void*)"BUFFER" }
};

static IDE_RC stfBufferEstimate( mtcNode*     aNode,
...
IDE_RC stfBufferEstimate( mtcNode*     aNode,
                          mtcTemplate* aTemplate,
                          mtcStack*    aStack,
                          SInt      /* aRemain */,
                          mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfAnalysis::buffer( aNode,
                                   aStack,
                                   aRemain,
                                   aInfo,
                                   aTemplate )
