...
static mtcName stfTouchesFunctionName[2] = {
    { stfTouchesFunctionName+1, 10, (void*)"ST_TOUCHES" }, // Fix BUG-15519
    { NULL, 7, (void*)"TOUCHES" }
};

static IDE_RC stfTouchesEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfTouchesEstimateRange(
                        mtcNode*,
                        mtcTemplate*,
                        UInt,
                        UInt*    aSize );

mtfModule stfTouches = {
...
IDE_RC stfTouchesExtractRange(
                        mtcNode*      aNode,
                        mtcTemplate*  aTemplate,
                        mtkRangeInfo* aInfo,
                        smiRange*     aRange );

IDE_RC stfTouchesCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfTouchesEstimate( mtcNode*     aNode,
                           mtcTemplate* aTemplate,
                           mtcStack*    aStack,
                           SInt      /* aRemain */,
                           mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfRelation::isTouches( aNode,
                                      aStack,
                                      aRemain,
                                      aInfo,
