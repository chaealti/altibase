...
static mtcName stfAsBinaryFunctionName[2] = {
    { stfAsBinaryFunctionName+1, 11, (void*)"ST_ASBINARY" }, // Fix BUG-15519
    { NULL, 8, (void*)"ASBINARY" }
};

static IDE_RC stfAsBinaryEstimate( mtcNode*     aNode,
                                   mtcTemplate* aTemplate,
                                   mtcStack*    aStack,
                                   SInt         aRemain,
                                   mtcCallBack* aCallBack );

mtfModule stfAsBinary = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfAsBinaryFunctionName,
    NULL,
...
IDE_RC stfAsBinaryCalculate( mtcNode*     aNode,
                             mtcStack*    aStack,
                             SInt         aRemain,
                             void*        aInfo,
                             mtcTemplate* aTemplate );
...
IDE_RC stfAsBinaryEstimate( mtcNode*     aNode,
                            mtcTemplate* aTemplate,
                            mtcStack*    aStack,
                            SInt      /* aRemain */,
                            mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfBasic::asBinary( aNode,
                                  aStack,
                                  aRemain,
                                  aInfo,
