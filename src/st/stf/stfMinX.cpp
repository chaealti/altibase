...
static mtcName stfMinXFunctionName[3] = {
    { stfMinXFunctionName+1, 7, (void*)"ST_MINX" }, 
    { NULL,                  4, (void*)"MINX" }
};

static IDE_RC stfMinXEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfMinXEstimate( mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        mtcCallBack* aCallBack )
