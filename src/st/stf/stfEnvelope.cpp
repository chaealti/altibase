...
static mtcName stfEnvelopeFunctionName[2] = {
    { stfEnvelopeFunctionName+1, 11, (void*)"ST_ENVELOPE" }, // Fix BUG-15519
    { NULL, 8, (void*)"ENVELOPE" }
};

static IDE_RC stfEnvelopeEstimate(
                        mtcNode*     aNode,
...
mtfModule stfEnvelope = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfEnvelopeFunctionName,
    NULL,
...
IDE_RC stfEnvelopeEstimate( mtcNode*     aNode,
                            mtcTemplate* aTemplate,
                            mtcStack*    aStack,
                            SInt      /* aRemain */,
                            mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfBasic::envelope( aNode,
                                  aStack,
                                  aRemain,
                                  aInfo,
