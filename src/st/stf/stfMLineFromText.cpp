...
static mtcName stfMLineFromTextFunctionName[2] = {
    { stfMLineFromTextFunctionName+1, 16, (void*)"ST_MLINEFROMTEXT" },
    { NULL, 13, (void*)"MLINEFROMTEXT" }
};

static IDE_RC stfMLineFromTextEstimate(
                        mtcNode*     aNode,
...
mtfModule stfMLineFromText = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfMLineFromTextFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfMLineFromTextEstimate
};

IDE_RC stfMLineFromTextCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfMLineFromTextEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    else
    {
        ...
        IDE_TEST( stfWKT::mlineFromText( sQmxMem,
                                         aStack[1].value,
                                         aStack[0].value,
