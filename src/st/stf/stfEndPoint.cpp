...
static mtcName stfEndPointFunctionName[2] = {
    { stfEndPointFunctionName+1, 11, (void*)"ST_ENDPOINT" }, // Fix BUG-15519
    { NULL, 8, (void*)"ENDPOINT" }
};

static IDE_RC stfEndPointEstimate(
                        mtcNode*     aNode,
...
mtfModule stfEndPoint = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfEndPointFunctionName,
    NULL,
...
IDE_RC stfEndPointEstimate( mtcNode*     aNode,
                            mtcTemplate* aTemplate,
                            mtcStack*    aStack,
                            SInt      /* aRemain */,
                            mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::endPoint( aNode,
                                      aStack,
                                      aRemain,
                                      aInfo,
