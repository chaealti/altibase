...
static mtcName stfGeoCollectionFromWKBFunctionName[2] = {
    { stfGeoCollectionFromWKBFunctionName+1, 18, (void*)"ST_GEOMCOLLFROMWKB" },
    { NULL, 15, (void*)"GEOMCOLLFROMWKB" }
};

static IDE_RC stfGeoCollectionFromWKBEstimate(
                        mtcNode*     aNode,
...
mtfModule stfGeoCollectionFromWKB = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfGeoCollectionFromWKBFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfGeoCollectionFromWKBEstimate
};

IDE_RC stfGeoCollectionFromWKBCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
static const mtcExecute stfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    stfGeoCollectionFromWKBCalculate,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC stfGeoCollectionFromWKBEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        mtcCallBack* aCallBack )
{
    ...
    *sModules = &mtdBinary;
    ...
    else
    {
        ...
        sNativeGeomSize += sMaxHeaderCount * ID_SIZEOF(SDouble) * 2;
    }
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    else
    {
        ...
        IDE_TEST( stfWKB::geoCollFromWKB(
                      sQmxMem,
                      aStack[1].value,
                      aStack[0].value,
