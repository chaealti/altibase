...
static mtcName stfMaxXFunctionName[3] = {
    { stfMaxXFunctionName+1, 7, (void*)"ST_MAXX" }, 
    { NULL,                  4, (void*)"MAXX" }
};

static IDE_RC stfMaxXEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfMaxXEstimate( mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::minMaxXY( aNode,
                                      aStack,
                                      aRemain,
                                      aInfo,
                                      aTemplate,
                                      ST_GET_MAXX) != IDE_SUCCESS );
