...
static mtcName stfUnionFunctionName[2] = {
    { stfUnionFunctionName+1, 8, (void*)"ST_UNION" }, // Fix BUG-15519
    { NULL, 5, (void*)"UNION" }
};

static IDE_RC stfUnionEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfUnionEstimate( mtcNode*     aNode,
                         mtcTemplate* aTemplate,
                         mtcStack*    aStack,
                         SInt      /* aRemain */,
                         mtcCallBack* aCallBack )
...
IDE_RC stfUnionCalculate( mtcNode*     aNode,
                          mtcStack*    aStack,
                          SInt         aRemain,
                          void*        aInfo,
                          mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfAnalysis::unions( aNode,
                                   aStack,
                                   aRemain,
                                   aInfo,
