...
// BUG-16103
static mtcName stfGeoCollectionFromTextFunctionName[2] = {
    { stfGeoCollectionFromTextFunctionName+1, 19, (void*)"ST_GEOMCOLLFROMTEXT" },
    { NULL, 16, (void*)"GEOMCOLLFROMTEXT" }
};

static IDE_RC stfGeoCollectionFromTextEstimate(
                        mtcNode*     aNode,
...
mtfModule stfGeoCollectionFromText = {
    ...
    mtf::finalizeDefault,
    stfGeoCollectionFromTextEstimate
};

IDE_RC stfGeoCollectionFromTextCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfGeoCollectionFromTextEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    else
    {
        ...
        IDE_TEST( stfWKT::geoCollFromText( sQmxMem,
                                           aStack[1].value,
                                           aStack[0].value,
