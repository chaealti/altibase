...
static mtcName stfGeometryNFunctionName[2] = {
    { stfGeometryNFunctionName+1, 12, (void*)"ST_GEOMETRYN" }, // Fix BUG-15519
    { NULL, 9, (void*)"GEOMETRYN" }
};

static IDE_RC stfGeometryNEstimate(
                        mtcNode*     aNode,
...
mtfModule stfGeometryN = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfGeometryNFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfGeometryNEstimate
};

IDE_RC stfGeometryNCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfGeometryNEstimate( mtcNode*     aNode,
                             mtcTemplate* aTemplate,
                             mtcStack*    aStack,
                             SInt      /* aRemain */,
                             mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::geometryN( aNode,
                                       aStack,
                                       aRemain,
                                       aInfo,
