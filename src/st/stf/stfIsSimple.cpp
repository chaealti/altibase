...
static mtcName stfIsSimpleFunctionName[2] = {
    { stfIsSimpleFunctionName+1, 11, (void*)"ST_ISSIMPLE" }, // Fix BUG-15519
    { NULL, 8, (void*)"ISSIMPLE" }
};

static IDE_RC stfIsSimpleEstimate(
                        mtcNode*     aNode,
...
mtfModule stfIsSimple = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfIsSimpleFunctionName,
    NULL,
...
IDE_RC stfIsSimpleEstimate( mtcNode*     aNode,
                            mtcTemplate* aTemplate,
                            mtcStack*    aStack,
                            SInt      /* aRemain */,
                            mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfBasic::isSimple( aNode,
                                  aStack,
                                  aRemain,
                                  aInfo,
