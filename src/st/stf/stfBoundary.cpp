...
static mtcName stfBoundaryFunctionName[2] = {
    { stfBoundaryFunctionName+1, 11, (void*)"ST_BOUNDARY" }, // Fix BUG-15519
    { NULL, 8, (void*)"BOUNDARY" }
};

static IDE_RC stfBoundaryEstimate( mtcNode*     aNode,
                                   mtcTemplate* aTemplate,
                                   mtcStack*    aStack,
                                   SInt         aRemain,
                                   mtcCallBack* aCallBack );

mtfModule stfBoundary = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfBoundaryFunctionName,
    NULL,
...
IDE_RC stfBoundaryEstimate( mtcNode*     aNode,
                            mtcTemplate* aTemplate,
                            mtcStack*    aStack,
                            SInt      /* aRemain */,
                            mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfBasic::boundary( aNode,
                                  aStack,
                                  aRemain,
                                  aInfo,
