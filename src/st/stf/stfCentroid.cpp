...
static mtcName stfCentroidFunctionName[2] = {
    { stfCentroidFunctionName+1, 11, (void*)"ST_CENTROID" }, // Fix BUG-15519
    { NULL, 8, (void*)"CENTROID" }
};

static IDE_RC stfCentroidEstimate(
                        mtcNode*     aNode,
...
mtfModule stfCentroid = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfCentroidFunctionName,
    NULL,
...
IDE_RC stfCentroidEstimate( mtcNode*     aNode,
                            mtcTemplate* aTemplate,
                            mtcStack*    aStack,
                            SInt      /* aRemain */,
                            mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::centroid( aNode,
                                      aStack,
                                      aRemain,
                                      aInfo,
