...
static mtcName stfCrossesFunctionName[2] = {
    { stfCrossesFunctionName+1, 10, (void*)"ST_CROSSES" }, // Fix BUG-15519
    { NULL, 7, (void*)"CROSSES" }
};

static IDE_RC stfCrossesEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfCrossesEstimateRange( 
                        mtcNode*,
                        mtcTemplate*,
                        UInt,
                        UInt*    aSize );

mtfModule stfCrosses = {
...
IDE_RC stfCrossesExtractRange(
                        mtcNode*      aNode,
                        mtcTemplate*  aTemplate,
                        mtkRangeInfo* aInfo,
                        smiRange*     aRange );

IDE_RC stfCrossesCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfCrossesEstimate( mtcNode*     aNode,
                           mtcTemplate* aTemplate,
                           mtcStack*    aStack,
                           SInt      /* aRemain */,
                           mtcCallBack* aCallBack )
