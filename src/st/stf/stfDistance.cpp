...
static mtcName stfDistanceFunctionName[2] = {
    { stfDistanceFunctionName+1, 11, (void*)"ST_DISTANCE" }, // Fix BUG-15519
    { NULL, 8, (void*)"DISTANCE" }
};

static IDE_RC stfDistanceEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfDistanceEstimate( mtcNode*     aNode,
                            mtcTemplate* aTemplate,
                            mtcStack*    aStack,
                            SInt      /* aRemain */,
                            mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfAnalysis::distance( aNode,
                                     aStack,
                                     aRemain,
                                     aInfo,
