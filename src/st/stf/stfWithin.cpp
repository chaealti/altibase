...
extern mtfModule stfGeoWithin;
extern mtfModule stfNotWithin;
// BUG-28934
extern mtdModule stdGeometry;

static mtcName stfWithinFunctionName[2] = {
    { stfWithinFunctionName+1, 9, (void*)"ST_WITHIN" }, // Fix BUG-15519
    { NULL, 6, (void*)"WITHIN" }
};

static IDE_RC stfWithinEstimate(
                        mtcNode*     aNode,
...
IDE_RC stfWithinExtractRange(
                        mtcNode*      aNode,
                        mtcTemplate*  aTemplate,
                        mtkRangeInfo* aInfo,
                        smiRange*     aRange );

IDE_RC stfWithinCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
static const mtcExecute stfExecute = {
    ...
    NULL,
    mtx::calculateNA,
    stfWithinEstimateRange,
    stfWithinExtractRange
};

IDE_RC stfWithinEstimate( mtcNode*     aNode,
                          mtcTemplate* aTemplate,
                          mtcStack*    aStack,
                          SInt      /* aRemain */,
                          mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfRelation::isWithin( aNode,
                                     aStack,
                                     aRemain,
                                     aInfo,
