...
static mtcName stfStartPointFunctionName[2] = {
    { stfStartPointFunctionName+1, 13, (void*)"ST_STARTPOINT" }, // Fix BUG-15519
    { NULL, 10, (void*)"STARTPOINT" }
};

static IDE_RC stfStartPointEstimate(
                        mtcNode*     aNode,
...
mtfModule stfStartPoint = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfStartPointFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfStartPointEstimate
};

IDE_RC stfStartPointCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfStartPointEstimate( mtcNode*     aNode,
                              mtcTemplate* aTemplate,
                              mtcStack*    aStack,
                              SInt      /* aRemain */,
                              mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( stfFunctions::startPoint( aNode,
                                        aStack,
                                        aRemain,
                                        aInfo,
