...
static mtcName stfMPolyFromTextFunctionName[2] = {
    { stfMPolyFromTextFunctionName+1, 16, (void*)"ST_MPOLYFROMTEXT" },
    { NULL, 13, (void*)"MPOLYFROMTEXT" }
};

static IDE_RC stfMPolyFromTextEstimate(
                        mtcNode*     aNode,
...
mtfModule stfMPolyFromText = {
    1|MTC_NODE_OPERATOR_FUNCTION,
    ~(MTC_NODE_INDEX_MASK),
    1.0,  // default selectivity (비교 연산자가 아님)
    stfMPolyFromTextFunctionName,
    NULL,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    stfMPolyFromTextEstimate
};

IDE_RC stfMPolyFromTextCalculate(
                        mtcNode*     aNode,
                        mtcStack*    aStack,
                        SInt         aRemain,
                        void*        aInfo,
...
IDE_RC stfMPolyFromTextEstimate(
                        mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    else
    {
        ...
        IDE_TEST( stfWKT::mpolyFromText( sQmxMem,
                                         aStack[1].value,
                                         aStack[0].value,
