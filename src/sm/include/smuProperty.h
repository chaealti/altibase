...
//smu
    ...
    SMU_PROPERTY_READONLY_DECLARE( UInt,  TempHashGroupRatio );/* Callback따로*/
    SMU_PROPERTY_READONLY_DECLARE( UInt,  TempSubHashGroupRatio );/* Callback따로*/
...
// smr
    ...
    {
        /* BUG-48409 temp log file 사용시에는 logfile 자동 삭제 무시 */
