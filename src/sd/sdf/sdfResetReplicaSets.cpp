 ...
 *
 * Syntax :
 *    SHARD_RESET_REPLICASETS( user_name VARCHAR,
 *                             node_name VARCHAR )
 *    RETURN 0
 *
 **********************************************************************/
...
static mtcName sdfFunctionName[1] = {
    { NULL, 23, (void*)"SHARD_RESET_REPLICASETS" }
};
...
mtfModule sdfResetReplicaSetsModule = {
...
IDE_RC sdfCalculate_ResetReplicaSets( mtcNode*     aNode,
                              mtcStack*    aStack,
                              SInt         aRemain,
                              void*        aInfo,
                              mtcTemplate* aTemplate );
 ...
 ***********************************************************************/
    ...
    else
    {
        ...
        // TargetNode의 AliveCheck를 수행함으로 Failover인지 Failback인지 구분할수 있음.
        // 추후 Failback을 위한 updateReplicaSet을 사용할때 고려
        ...
        switch ( sInternalOP )
        {
            case SDI_INTERNAL_OP_FAILOVER:
                IDE_TEST( sdm::updateReplicaSet4Failover( sStatement,
                                                          sOldNodeNameStr,
                                                          sNewNodeNameStr ) != IDE_SUCCESS );
                break;
            case SDI_INTERNAL_OP_FAILBACK:
                IDE_TEST( sdm::updateReplicaSet4Failback( sStatement,
                                                          sOldNodeNameStr,
                                                          sNewNodeNameStr ) != IDE_SUCCESS );
                break;
