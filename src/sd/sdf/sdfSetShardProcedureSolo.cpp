 ...
 *
 * Syntax :
 *    SHARD_SET_SHARD_PROCEDURE_SOLO( user_name    VARCHAR,
 *                                    proc_name    VARCHAR,
 *                                    node_name     VARCHAR,
...
static mtcName sdfFunctionName[1] = {
    { NULL, 30, (void*)"SHARD_SET_SHARD_PROCEDURE_SOLO" }
};
...
mtfModule sdfSetShardProcedureSoloModule = {
...
IDE_RC sdfCalculate_SetShardProcedureSolo( mtcNode*     aNode,
                                           mtcStack*    aStack,
                                           SInt         aRemain,
                                           void*        aInfo,
                                           mtcTemplate* aTemplate );
...
static const mtcExecute sdfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    sdfCalculate_SetShardProcedureSolo,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
                                           ...
                                           mtcTemplate* aTemplate )
{
    ...
    else
    {
        ...
        // proc replace
        sProcReplace = (mtdCharType*)aStack[4].value;
