...
static mtcName sdfFunctionName[1] = {
    { NULL, 25, (void*)"SHARD_RESET_NODE_EXTERNAL" }
};
...
mtfModule sdfResetNodeExternalModule = {
...
IDE_RC sdfCalculate_ResetNodeExternal( mtcNode*     aNode,
                               mtcStack*    aStack,
                               SInt         aRemain,
                               void*        aInfo,
                               mtcTemplate* aTemplate );
...
static const mtcExecute sdfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    sdfCalculate_ResetNodeExternal,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
 ...
 *
 * Description :
 *      Reset Data Node External Access Information
 *
 * Implementation :
 *      Argument Validation
 ...
 ***********************************************************************/
    ...
    else
    {
        ...
        IDE_TEST( sdm::updateNodeExternal( sStatement,
                                           (SChar*)sNodeNameStr,
