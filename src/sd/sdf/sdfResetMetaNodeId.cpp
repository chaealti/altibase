 ...
 *
 * Syntax :
 *    SHARD_RESET_META_NODE_ID( meta_node_id in integer )
 *    RETURN 0
 *
 **********************************************************************/
...
static mtcName sdfFunctionName[1] = {
    { NULL, 24, (void*)"SHARD_RESET_META_NODE_ID" }
};
...
IDE_RC sdfCalculate_ResetMetaNodeId( mtcNode*     aNode,
                                     mtcStack*    aStack,
                                     SInt         aRemain,
                                     void*        aInfo,
                                     mtcTemplate* aTemplate );
