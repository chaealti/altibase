...
/*
 * INTEGER REMOTE_GET_RESULT_COUNT_BATCH( dblink_name IN VARCHAR,
...
{
    { NULL, 29, (void *)"REMOTE_GET_RESULT_COUNT_BATCH" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    IDE_TEST( dkmCalculateGetResultCountBatch( sQcStatement,
                                               sSession,
                                               sDblinkName,
                                               sStatementId,
                                               &sResultCount )
    ...
    *( (mtdIntegerType *)aStack[0].value ) = sResultCount;
 ...
 * Function module.
 */ 
mtfModule dkifRemoteGetResultCountBatch =
{
