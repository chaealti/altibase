...
/*
 * FLOAT( precision ) REMOTE_GET_COLUMN_VALUE_FLOAT ( dblink_name IN VARCHAR,
...
{
    { NULL, 29, (void *)"REMOTE_GET_COLUMN_VALUE_FLOAT" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    /* BUG-36527 */
    IDE_TEST_RAISE( sColumn->module->id != MTD_FLOAT_ID, ERR_WRONG_TYPE );
                                    ...
                                    mtcCallBack * aCallBack )
{
    ...
    const mtdModule * sReturnModule = &mtdFloat;
 ...
 * Function module.
 */ 
mtfModule dkifRemoteGetColumnValueFloat =
{
