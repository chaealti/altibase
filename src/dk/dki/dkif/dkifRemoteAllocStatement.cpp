...
/*
 * BIGINT REMOTE_ALLOC_STATEMENT( dblink_name IN VARCHAR,
...
{
    { NULL, 22, (void *)"REMOTE_ALLOC_STATEMENT" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    IDE_TEST( dkmCalculateAllocStatement( sQcStatement,
                                          sSession,
                                          sDblinkName,
                                          sQuery,
                                          &sStatementId )
 ...
 * Function module.
 */ 
mtfModule dkifRemoteAllocStatement =
{
