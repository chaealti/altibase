...
/*
 * REAL REMOTE_GET_COLUMN_VALUE_REAL ( dblink_name IN VARCHAR,
...
{
    { NULL, 28, (void *)"REMOTE_GET_COLUMN_VALUE_REAL" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    /* BUG-36527 */
    IDE_TEST_RAISE( sColumn->module->id != MTD_REAL_ID, ERR_WRONG_TYPE );
                                    ...
                                    mtcCallBack * aCallBack )
{
    ...
    const mtdModule* sReturnModule = &mtdReal;
 ...
 * Function module.
 */ 
mtfModule dkifRemoteGetColumnValueReal =
{
