...
/*
 * SMALLINT REMOTE_GET_COLUMN_VALUE_SMALLINT ( dblink_name IN VARCHAR,
...
{
    { NULL, 32, (void *)"REMOTE_GET_COLUMN_VALUE_SMALLINT" }
};
 ...
 *
 * aStack[0] is return value ( SMALLINT ).
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    /* BUG-36527 */
    IDE_TEST_RAISE( sColumn->module->id != MTD_SMALLINT_ID, ERR_WRONG_TYPE );
                                    ...
                                    mtcCallBack * aCallBack )
{
    ...
    const mtdModule* sReturnModule = &mtdSmallint;
 ...
 * Function module.
 */ 
mtfModule dkifRemoteGetColumnValueSmallint =
{
