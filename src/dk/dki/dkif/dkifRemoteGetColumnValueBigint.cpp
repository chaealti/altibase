...
/*
 * BIGINT REMOTE_GET_COLUMN_VALUE_BIGINT ( dblink_name IN VARCHAR,
...
{
    { NULL, 30, (void *)"REMOTE_GET_COLUMN_VALUE_BIGINT" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    /* BUG-36527 */
    IDE_TEST_RAISE( sColumn->module->id != MTD_BIGINT_ID, ERR_WRONG_TYPE );
 ...
 * Function module.
 */ 
mtfModule dkifRemoteGetColumnValueBigint =
{
