...
/*
 * INTEGER REMOTE_EXECUTE_STATEMENT( dblink_name IN VARCHAR,
...
{
    { NULL, 24, (void *)"REMOTE_EXECUTE_STATEMENT" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    IDE_TEST( dkmCalculateExecuteStatement(
                  sQcStatement,
                  sSession,
                  sDblinkName,
                  sStatementId,
 ...
 * Function module.
 */ 
mtfModule dkifRemoteExecuteStatement =
{
