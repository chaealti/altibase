...
/*
 * INTEGER REMOTE_EXECUTE_IMMEDIATE_INTERNAL( dblink_name IN VARCHAR,
 *                                            remote_query IN VARCHAR )
 *
 * Only this function is used in function or procedure.
 *
 * This function is not used directly.
 * Wrapper function REMOTE_EXECUTE_IMMEDIATE will be used this function.
 * Wrapper function is defined when database is created.
 */
...
{
    { NULL, 33, (void *)"REMOTE_EXECUTE_IMMEDIATE_INTERNAL" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    IDE_TEST( dkifUtilConvertMtdCharToCString( (mtdCharType *)aStack[2].value,
                                               &sQuery )
              != IDE_SUCCESS );
    sStage = 1;
    ...
    IDE_TEST( dkmCalculateExecuteImmediate(
                  sQcStatement,
                  sSession,
                  sDblinkName,
                  sQuery,
    ...
    *( (mtdIntegerType *)aStack[0].value ) = sResult;
    ...
    sStage = 0;
    (void)dkifUtilFreeCString( sQuery );
...
{
    const mtdModule * sArgumentModules[2] =
    {
        &mtdVarchar,
        &mtdVarchar,
    };
 ...
 * Function module.
 */ 
mtfModule dkifRemoteExecuteImmediateInternal =
{
