...
/*
 * INTEGER REMOTE_GET_RESULT_BATCH( dblink_name IN VARCHAR,
...
{
    { NULL, 23, (void *)"REMOTE_GET_RESULT_BATCH" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    sIndex = *( (mtdIntegerType *)aStack[3].value );
    ...
    IDE_TEST( dkmCalculateGetResultBatch( sQcStatement,
                                          sSession,
                                          sDblinkName,
                                          sStatementId,
                                          sIndex,
...
{
    const mtdModule * sArgumentModules[3] =
    {
        &mtdVarchar,
        &mtdBigint,
        &mtdInteger,
 ...
 * Function module.
 */ 
mtfModule dkifRemoteGetResultBatch =
{
