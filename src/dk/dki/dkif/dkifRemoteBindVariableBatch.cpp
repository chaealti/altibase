...
/*
 * INTEGER REMOTE_BIND_VARIABLE_BATCH( dblink_name          IN VARCHAR,
...
{
    { NULL, 26, (void *)"REMOTE_BIND_VARIABLE_BATCH" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    IDE_TEST( dkmCalculateBindVariableBatch(
                  sQcStatement,
                  sSession,
                  sDblinkName,
                  sStatementId,
 ...
 * Function module.
 */ 
mtfModule dkifRemoteBindVariableBatch =
{
