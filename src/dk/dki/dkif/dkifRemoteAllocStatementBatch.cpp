...
/*
 * BIGINT REMOTE_ALLOC_STATEMENT_BATCH( dblink_name IN VARCHAR,
 *                                      remote_stmt_to_prepare IN VARCHAR )
 *
...
{
    { NULL, 28, (void *)"REMOTE_ALLOC_STATEMENT_BATCH" }
};
 ...
 *
 * aStack[0] is return value ( BIGINT ).
 * aStack[1] is dblink_name.
 * aStack[2] is remote_stmt_to_prepare.
 */ 
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    IDE_TEST( dkmCalculateAllocStatementBatch( sQcStatement,
                                               sSession,
                                               sDblinkName,
                                               sQuery,
                                               &sStatementId )
    ...
    *( (mtdBigintType *)aStack[0].value ) = sStatementId;
                                    ...
                                    mtcCallBack * aCallBack )
{
    ...
    const mtdModule* sReturnModule = &mtdBigint;
 ...
 * Function module.
 */ 
mtfModule dkifRemoteAllocStatementBatch =
{
