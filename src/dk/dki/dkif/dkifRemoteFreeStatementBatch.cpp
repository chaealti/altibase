...
/*
 * INTEGER REMOTE_FREE_STATEMENT_BATCH( dblink_name IN VARCHAR,
...
{
    { NULL, 27, (void *)"REMOTE_FREE_STATEMENT_BATCH" }
};
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    IDE_TEST( dkmCalculateFreeStatementBatch(
                  sQcStatement,
                  sSession,
                  sDblinkName,
                  sStatementId )
 ...
 * Function module.
 */ 
mtfModule dkifRemoteFreeStatementBatch =
{
