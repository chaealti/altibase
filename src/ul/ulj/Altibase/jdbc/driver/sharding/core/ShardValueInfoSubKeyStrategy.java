...
public class ShardValueInfoSubKeyStrategy implements ShardValueInfoStrategy
{
    ...
    public ShardValueInfoSubKeyStrategy(CmShardAnalyzeResult aAnalyzeResult)
    {
    ...
    {
        return mShardAnalyzeResult.getShardSubValueCount();
    }

    public ShardSplitMethod getShardSplitMethod()
    {
        return mShardAnalyzeResult.getShardSubSplitMethod();
    }

    public void addShardValue(ShardValueInfo aShardValueInfo)
    {
        mShardAnalyzeResult.addShardSubValue(aShardValueInfo);
    }
}
