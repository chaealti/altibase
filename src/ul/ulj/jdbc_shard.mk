...
JDBC_SHARD_SRC =      $(DRIVER_DIR)/cm/CmProtocolContextShardConnect.java                           \
                      ...
                      $(DRIVER_DIR)/sharding/core/ShardTransactionLevel.java                        \
                      ...
                      $(DRIVER_DIR)/sharding/algorithm/ListShardingValue.java                       \
                      $(DRIVER_DIR)/sharding/algorithm/PreciseShardingValue.java                    \
                      $(DRIVER_DIR)/sharding/algorithm/RangeShardingAlgorithm.java                  \
                      $(DRIVER_DIR)/sharding/algorithm/ShardingAlgorithm.java                       \
                      $(DRIVER_DIR)/sharding/algorithm/ShardingValue.java                           \
                      ...
                      $(DRIVER_DIR)/sharding/executor/CallableStatementUnit.java                    \
                      ...
                      $(DRIVER_DIR)/sharding/executor/PreparedStatementUnit.java                    \
                      $(DRIVER_DIR)/sharding/executor/StatementExecutor.java                        \
                      $(DRIVER_DIR)/sharding/executor/StatementUnit.java                            \
                      ...
                      $(DRIVER_DIR)/sharding/routing/SQLExecutionUnit.java                          \
                      $(DRIVER_DIR)/sharding/routing/SQLRouteResult.java                            \
...
JDBC_SHARD_SRC4WAS =  $(DRIVER_DIR4WAS)/cm/CmProtocolContextShardConnect.java                           \
                      ...
                      $(DRIVER_DIR4WAS)/sharding/core/ShardTransactionLevel.java                        \
                      ...
                      $(DRIVER_DIR4WAS)/sharding/algorithm/ListShardingValue.java                       \
                      $(DRIVER_DIR4WAS)/sharding/algorithm/PreciseShardingValue.java                    \
                      $(DRIVER_DIR4WAS)/sharding/algorithm/RangeShardingAlgorithm.java                  \
                      $(DRIVER_DIR4WAS)/sharding/algorithm/ShardingAlgorithm.java                       \
                      $(DRIVER_DIR4WAS)/sharding/algorithm/ShardingValue.java                           \
                      ...
                      $(DRIVER_DIR4WAS)/sharding/executor/CallableStatementUnit.java                    \
                      ...
                      $(DRIVER_DIR4WAS)/sharding/executor/PreparedStatementUnit.java                    \
                      $(DRIVER_DIR4WAS)/sharding/executor/StatementExecutor.java                        \
                      $(DRIVER_DIR4WAS)/sharding/executor/StatementUnit.java                            \
                      ...
                      $(DRIVER_DIR4WAS)/sharding/routing/SQLExecutionUnit.java                          \
                      $(DRIVER_DIR4WAS)/sharding/routing/SQLRouteResult.java                            \
