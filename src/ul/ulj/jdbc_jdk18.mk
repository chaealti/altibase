...
JDBC_SRC =      $(DRIVER_DIR)/datatype/ColumnConst.java                     \
                ...
                $(DRIVER_DIR)/datatype/BatchRowHandle.java                  \
                $(DRIVER_DIR)/datatype/RowHandle.java                       \
                $(DRIVER_DIR)/datatype/DynamicArrayRowHandle.java           \
                $(DRIVER_DIR)/datatype/ArrayListRowHandle.java              \
                ...
                $(DRIVER_DIR)/cm/CmSetPropertyResult.java                   \
                ...
                $(DRIVER_DIR)/AbstractCallableStatement.java                \
                $(DRIVER_DIR)/AbstractConnection.java                       \
                $(DRIVER_DIR)/AbstractPreparedStatement.java                \
                $(DRIVER_DIR)/AbstractResultSet.java                        \
                $(DRIVER_DIR)/AltibaseJDBCType.java                         \
                $(DRIVER_DIR)/WrapperAdapter.java                           \
...
JDBC_SRC4WAS =  $(DRIVER_DIR4WAS)/datatype/ColumnConst.java                 \
                ...
                $(DRIVER_DIR4WAS)/datatype/BatchRowHandle.java              \
                $(DRIVER_DIR4WAS)/datatype/RowHandle.java                   \
                $(DRIVER_DIR4WAS)/datatype/DynamicArrayRowHandle.java       \
                $(DRIVER_DIR4WAS)/datatype/ArrayListRowHandle.java          \
                ...
                $(DRIVER_DIR4WAS)/cm/CmSetPropertyResult.java               \
                ...
                $(DRIVER_DIR4WAS)/AbstractCallableStatement.java            \
                $(DRIVER_DIR4WAS)/AbstractConnection.java                   \
                $(DRIVER_DIR4WAS)/AbstractPreparedStatement.java            \
                $(DRIVER_DIR4WAS)/AbstractResultSet.java                    \
                $(DRIVER_DIR4WAS)/AltibaseJDBCType.java                     \
                $(DRIVER_DIR4WAS)/WrapperAdapter.java                       \
