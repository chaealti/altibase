...
ACI_RC ulncCHAR_SBIGINT(ulnFnContext  *aFnContext,
                        ...
                        acp_uint16_t   aRowNumber)
{
    ...
    *(acp_sint64_t *)aAppBuffer->mBuffer = sBigIntValue;

    aLength->mWritten = ACI_SIZEOF(acp_sint64_t);
    aLength->mNeeded  = ACI_SIZEOF(acp_sint64_t);
...
ACI_RC ulncVARCHAR_SBIGINT(ulnFnContext  *aFnContext,
                           ulnAppBuffer  *aAppBuffer,
                           ulnColumn     *aColumn,
                           ulnLengthPair *aLength,
                           acp_uint16_t   aRowNumber)
{
    return ulncCHAR_SBIGINT(aFnContext,
                            aAppBuffer,
                            aColumn,
                            aLength,
                            aRowNumber);
...
ACI_RC ulncVARBIT_SBIGINT(ulnFnContext  *aFnContext,
                          ulnAppBuffer  *aAppBuffer,
                          ulnColumn     *aColumn,
                          ulnLengthPair *aLength,
                          acp_uint16_t   aRowNumber)
{
    return ulncBIT_SBIGINT(aFnContext,
                           aAppBuffer,
                           aColumn,
                           aLength,
                           aRowNumber);
...
ACI_RC ulncBIT_SBIGINT(ulnFnContext  *aFnContext,
                       ulnAppBuffer  *aAppBuffer,
                       ulnColumn     *aColumn,
                       ulnLengthPair *aLength,
                       acp_uint16_t   aRowNumber)
{
    ...
    *(acp_sint64_t *)aAppBuffer->mBuffer = (acp_sint64_t)sBitValue;
...
ACI_RC ulncSMALLINT_SBIGINT(ulnFnContext  *aFnContext,
                            ulnAppBuffer  *aAppBuffer,
                            ulnColumn     *aColumn,
                            ulnLengthPair *aLength,
                            acp_uint16_t   aRowNumber)
{
    ...
    *(acp_sint64_t *)aAppBuffer->mBuffer = (acp_sint64_t)sSmallIntValue;
...
ACI_RC ulncINTEGER_SBIGINT(ulnFnContext  *aFnContext,
                           ulnAppBuffer  *aAppBuffer,
                           ulnColumn     *aColumn,
                           ulnLengthPair *aLength,
                           acp_uint16_t   aRowNumber)
{
    ...
    *(acp_sint64_t *)aAppBuffer->mBuffer = (acp_sint64_t)sSInt32Value;
...
ACI_RC ulncBIGINT_SBIGINT(ulnFnContext  *aFnContext,
                          ulnAppBuffer  *aAppBuffer,
                          ulnColumn     *aColumn,
                          ulnLengthPair *aLength,
                          acp_uint16_t   aRowNumber)
...
ACI_RC ulncREAL_SBIGINT(ulnFnContext  *aFnContext,
                        ulnAppBuffer  *aAppBuffer,
                        ulnColumn     *aColumn,
                        ulnLengthPair *aLength,
                        acp_uint16_t   aRowNumber)
{
    ...
    ACI_TEST_RAISE(sFloatValue < ACP_SINT64_MIN, LABEL_OUT_OF_RANGE);
    ACI_TEST_RAISE(sFloatValue > ACP_SINT64_MAX, LABEL_OUT_OF_RANGE);
    ...
    *(acp_sint64_t *)aAppBuffer->mBuffer = (acp_sint64_t)sBigIntValue;
...
ACI_RC ulncDOUBLE_SBIGINT(ulnFnContext  *aFnContext,
                          ulnAppBuffer  *aAppBuffer,
                          ulnColumn     *aColumn,
                          ulnLengthPair *aLength,
                          acp_uint16_t   aRowNumber)
{
    ...
    ACI_TEST_RAISE(sDoubleValue < ACP_SINT64_MIN, LABEL_OUT_OF_RANGE);
    ACI_TEST_RAISE(sDoubleValue > ACP_SINT64_MAX, LABEL_OUT_OF_RANGE);
...
ACI_RC ulncINTERVAL_SBIGINT(ulnFnContext  *aFnContext,
                            ulnAppBuffer  *aAppBuffer,
                            ulnColumn     *aColumn,
                            ulnLengthPair *aLength,
                            acp_uint16_t   aRowNumber)
...
ACI_RC ulncNUMERIC_SBIGINT(ulnFnContext  *aFnContext,
                           ulnAppBuffer  *aAppBuffer,
                           ulnColumn     *aColumn,
                           ulnLengthPair *aLength,
                           acp_uint16_t   aRowNumber)
{
    ...
    *(acp_sint64_t *)aAppBuffer->mBuffer = (acp_sint64_t)sSBigIntValue;
...
ACI_RC ulncNCHAR_SBIGINT(ulnFnContext  *aFnContext,
                         ulnAppBuffer  *aAppBuffer,
                         ulnColumn     *aColumn,
                         ulnLengthPair *aLength,
                         acp_uint16_t   aRowNumber)
...
ACI_RC ulncNVARCHAR_SBIGINT(ulnFnContext  *aFnContext,
                            ulnAppBuffer  *aAppBuffer,
                            ulnColumn     *aColumn,
                            ulnLengthPair *aLength,
                            acp_uint16_t   aRowNumber)
{
    return ulncNCHAR_SBIGINT(aFnContext,
                             aAppBuffer,
                             aColumn,
                             aLength,
                             aRowNumber);
