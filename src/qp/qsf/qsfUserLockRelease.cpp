 ...
 *
 * Syntax :
 *     USER_LOCK_RELEASE( id IN INTEGER )
 *     RETURN INTEGER;
 **********************************************************************/
...
static mtcName qsfFunctionName[1] = {
    { NULL, 17, (void *)"USER_LOCK_RELEASE" }
};
...
mtfModule qsfUserLockReleaseModule = {
...
IDE_RC qsfCalculate_UserLockRelease( mtcNode     * aNode,
                                     mtcStack    * aStack,
                                     SInt          aRemain,
                                     void        * aInfo,
                                     mtcTemplate * aTemplate );
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    else
    {
        ...
        IDE_TEST( qcuSessionObj::releaseUserLock( sSessionObjInfo,
                                                  sUserLockID,
                                                  &sResult )
                  != IDE_SUCCESS );
