...
/***********************************************************************
 * $Id: qsfMutexLock.cpp 18910 2006-11-13 01:56:34Z shsuh $
 **********************************************************************/
...
IDE_RC qsfCalculate_SpMutexLock( 
                            mtcNode*     aNode,
                            mtcStack*    aStack,
                            SInt         aRemain,
                            void*        aInfo,
...
IDE_RC qsfCalculate_SpMutexLock( 
                     ...
                     mtcTemplate* aTemplate )
{
#define IDE_FN "IDE_RC qsfCalculate_SpMutexLock"
    IDE_MSGLOG_FUNC(IDE_MSGLOG_BODY(""));
    ...
    *(mtdIntegerType *)aStack[0].value = idlOS::thread_mutex_lock( (PDL_thread_mutex_t *)sAddress );

    ideLog::log( IDE_QP_0, 
                 "[LOCK] %s %llu rc: %d errno: %d\n",
                 sBuffer, 
                 sAddress, 
    ...
    IDE_EXCEPTION( err_mutex_lock_not_allowed );
    {
