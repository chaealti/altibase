...
/***********************************************************************
 * $Id: qsfRegister.cpp 18910 2006-11-13 01:56:34Z shsuh $
 **********************************************************************/
...
IDE_RC mtfCalculate_SpRegister( 
                            mtcNode*     aNode,
                            mtcStack*    aStack,
                            SInt         aRemain,
                            void*        aInfo,
                     ...
                     mtcTemplate* aTemplate )
{
    ...
    else
    {
        ...
        IDE_TEST( qci::mSessionCallback.mRegister( sSession,
                                                   (SChar *)sArg1->value,
