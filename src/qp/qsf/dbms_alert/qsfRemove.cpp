...
/***********************************************************************
 * $Id: qsfRemove.cpp 18910 2006-11-13 01:56:34Z shsuh $
 **********************************************************************/
                     ...
                     mtcTemplate* aTemplate )
{
    ...
    else
    {
        ...
        IDE_TEST( qci::mSessionCallback.mRemove( sSession,
                                                 (SChar *)sArg1->value,
