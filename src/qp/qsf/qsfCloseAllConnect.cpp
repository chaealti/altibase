...
IDE_RC qsfCalculate_CloseAllConnect( mtcNode*     aNode,
                                     mtcStack*    aStack,
                                     SInt         aRemain,
                                     void*        aInfo,
                                     mtcTemplate* aTemplate );
 ...
 ***********************************************************************/
    ...
    IDE_TEST( qcuSessionObj::closeAllConnection( (qcSessionObjInfo*)(sSession->mQPSpecific.mSessionObj) )
                                                 != IDE_SUCCESS );
