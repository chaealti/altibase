...
IDE_RC qsfCalculate_SpOpenCursor( 
                            mtcNode*     aNode,
                            mtcStack*    aStack,
                            SInt         aRemain,
                            void*        aInfo,
                     ...
                     mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( qcg::openCursor( sStatement,
                               &sCursorId )
              != IDE_SUCCESS );

    *(mtdIntegerType *)aStack[0].value = sCursorId; 
