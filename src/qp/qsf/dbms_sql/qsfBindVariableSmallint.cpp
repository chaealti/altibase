...
static mtcName qsfFunctionName[1] = {
    { NULL, 25, (void*)"SP_BIND_VARIABLE_SMALLINT" }
};
...
mtfModule qsfBindVariableSmallintModule = {
...
extern IDE_RC qsfCalculate_SpBindVariable( 
                            mtcNode*     aNode,
                            mtcStack*    aStack,
                            SInt         aRemain,
                            void*        aInfo,
...
IDE_RC qsfEstimate( mtcNode*     aNode,
                    ...
                    mtcCallBack* aCallBack )
{
    const mtdModule *sModule[3] = { &mtdInteger, &mtdVarchar, &mtdSmallint };
