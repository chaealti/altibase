...
static mtcName qsfFunctionName[1] = {
    { NULL, 23, (void*)"SP_COLUMN_VALUE_NUMERIC" }
};
...
mtfModule qsfColumnValueNumericModule = {
...
IDE_RC qsfEstimate( mtcNode*     aNode,
                    ...
                    mtcCallBack* aCallBack )
{
    const mtdModule *sModule[5] = { &mtdInteger, &mtdInteger, &mtdNumeric, &mtdInteger, &mtdInteger };
