...
static mtcName qsfFunctionName[1] = {
    { NULL, 24, (void*)"SP_COLUMN_VALUE_SMALLINT" }
};
...
mtfModule qsfColumnValueSmallintModule = {
...
IDE_RC qsfEstimate( mtcNode*     aNode,
                    ...
                    mtcCallBack* aCallBack )
{
    const mtdModule *sModule[5] = { &mtdInteger, &mtdInteger, &mtdSmallint, &mtdInteger, &mtdInteger };
