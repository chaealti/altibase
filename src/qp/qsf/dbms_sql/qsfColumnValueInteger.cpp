...
static mtcName qsfFunctionName[1] = {
    { NULL, 23, (void*)"SP_COLUMN_VALUE_INTEGER" }
};
...
mtfModule qsfColumnValueIntegerModule = {
...
IDE_RC qsfEstimate( mtcNode*     aNode,
                    ...
                    mtcCallBack* aCallBack )
{
    const mtdModule *sModule[5] = { &mtdInteger, &mtdInteger, &mtdInteger, &mtdInteger, &mtdInteger };
