...
static mtcName qsfFunctionName[1] = {
    { NULL, 17, (void*)"SP_EXECUTE_CURSOR" }
};
...
mtfModule qsfExecuteCursorModule = {
...
IDE_RC qsfCalculate_SpExecuteCursor( 
                            mtcNode*     aNode,
                            mtcStack*    aStack,
                            SInt         aRemain,
                            void*        aInfo,
                     ...
                     mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( qcg::executeCursor( sStatement, 
                                  sCursorId, 
                                  &sRowCount ) 
              != IDE_SUCCESS );

    *(mtdBigintType *)aStack[0].value = sRowCount;
