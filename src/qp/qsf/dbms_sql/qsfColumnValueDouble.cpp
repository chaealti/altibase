...
static mtcName qsfFunctionName[1] = {
    { NULL, 22, (void*)"SP_COLUMN_VALUE_DOUBLE" }
};
...
mtfModule qsfColumnValueDoubleModule = {
...
IDE_RC qsfEstimate( mtcNode*     aNode,
                    ...
                    mtcCallBack* aCallBack )
{
    const mtdModule *sModule[5] = { &mtdInteger, &mtdInteger, &mtdDouble, &mtdInteger, &mtdInteger };
