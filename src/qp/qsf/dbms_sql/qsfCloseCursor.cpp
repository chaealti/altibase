...
mtfModule qsfCloseCursorModule = {
...
IDE_RC qsfCalculate_SpCloseCursor( 
                            mtcNode*     aNode,
                            mtcStack*    aStack,
                            SInt         aRemain,
                            void*        aInfo,
                     ...
                     mtcTemplate* aTemplate )
{
    ...
    IDE_TEST( qcg::closeCursor( sStatement, sCursorId ) 
              != IDE_SUCCESS );
