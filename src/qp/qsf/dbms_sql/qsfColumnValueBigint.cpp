...
static mtcName qsfFunctionName[1] = {
    { NULL, 22, (void*)"SP_COLUMN_VALUE_BIGINT" }
};
...
mtfModule qsfColumnValueBigintModule = {
...
IDE_RC qsfEstimate( mtcNode*     aNode,
                    ...
                    mtcCallBack* aCallBack )
{
    const mtdModule *sModule[5] = { &mtdInteger, &mtdInteger, &mtdBigint, &mtdInteger, &mtdInteger };
