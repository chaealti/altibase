...
/***********************************************************************
 * $Id: qtcSpCursorIsOpen.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
IDE_RC mtfCalculate_SpCursorIsOpen( mtcNode*     aNode,
                                    mtcStack*    aStack,
                                    SInt         aRemain,
                                    void*        aInfo,
                                    mtcTemplate* aTemplate );

IDE_RC mtfCalculate_SpRefCursorIsOpen( mtcNode*     aNode,
                                       mtcStack*    aStack,
                                       SInt         aRemain,
                                       void*        aInfo,
                                       mtcTemplate* aTemplate );
...
static const mtcExecute mtfExecuteRefCursor = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfCalculate_SpRefCursorIsOpen,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfCalculate_SpCursorIsOpen( mtcNode*     aNode,
                                    ...
                                    mtcTemplate* aTemplate )
{
#define IDE_FN "IDE_RC mtfCalculate_SpCursorIsOpen"
    IDE_MSGLOG_FUNC(IDE_MSGLOG_BODY(""));
    ...
    if ( (QSX_CURSOR_IS_OPEN( (qsxCursorInfo*)aStack[1].value )) == ID_TRUE )
    {
                                       ...
                                       mtcTemplate* aTemplate )
{
    ...
    if( QSX_REF_CURSOR_IS_OPEN( (qsxRefCursorInfo *) aStack[1].value ) == ID_TRUE )
    {
        *(mtdBooleanType*)aStack[0].value = MTD_BOOLEAN_TRUE;
    }
    else
