...
/***********************************************************************
 * $Id: qtcSpCursorIsNotOpen.cpp 85090 2019-03-28 01:15:28Z andrew.shin $
 **********************************************************************/
...
mtfModule qtc::spCursorIsNotOpenModule = {
...
IDE_RC mtfCalculate_SpCursorIsNotOpen( mtcNode*     aNode,
                                       mtcStack*    aStack,
                                       SInt         aRemain,
                                       void*        aInfo,
                                       mtcTemplate* aTemplate );

IDE_RC mtfCalculate_SpRefCursorIsNotOpen( mtcNode*     aNode,
                                          mtcStack*    aStack,
                                          SInt         aRemain,
                                          void*        aInfo,
                                          mtcTemplate* aTemplate );
...
static const mtcExecute mtfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfCalculate_SpCursorIsNotOpen,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
static const mtcExecute mtfExecuteRefCursor = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfCalculate_SpRefCursorIsNotOpen,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfCalculate_SpCursorIsNotOpen( mtcNode*     aNode,
                                       ...
                                       mtcTemplate* aTemplate )
{
#define IDE_FN "IDE_RC mtfCalculate_SpCursorIsNotOpen"
    IDE_MSGLOG_FUNC(IDE_MSGLOG_BODY(""));
    ...
    if ( (QSX_CURSOR_IS_OPEN( (qsxCursorInfo*)aStack[1].value )) == ID_FALSE )
    {
