...
//TASK-1878
#ifdef _WIN32
#define PDL_OFF_T    __int64
#else
#define PDL_OFF_T    off_t
#endif
...
# if defined(PDL_WIN32) || defined(PDL_HAS_WINCE) || defined(SYMBIAN) || defined(VXWORKS)
// for win MVC compile
...
#   define PDL_UNUSED_ARG(a) (void)(a);
# else
#   define PDL_UNUSED_ARG(a) (void)(a);
# endif /* ghs */
...
#   if defined (PDL_WIN32)
   ...
   // strings!
typedef /*BUGBUG_NT*//* char* */int/*BUGBUG_NT*/ key_t;
# else
typedef int key_t;
#   endif /* PDL_WIN32 */
...
// functions. PDL_THR_FUNC_RETURN is the type defined as the thread
// function's return type, except when the thread function doesn't return
// anything (pSoS). The PDL_THR_FUNC_NO_RETURN_VAL macro is used to
...
# if defined (VXWORKS)
//typedef FUNCPTR PDL_THR_FUNC;  // where typedef int (*FUNCPTR) (...)
typedef int PDL_THR_FUNC_RETURN;
...
typedef DWORD PDL_THR_FUNC_RETURN;
# else
typedef void* PDL_THR_FUNC_RETURN;
# endif /* VXWORKS */
//typedef PDL_THR_FUNC_RETURN (*PDL_THR_FUNC)(void *);
...
#     include /**/ "sys_conf.h" /* system configuration file */
...
struct stat
{
  ...
  PDL_OFF_T      st_size;  // file size, in bytes
...
typedef struct { int id; char name[32]; } PDL_hthread_t;
// Key type: the PDL TSS emulation requires the key type be unsigned,
// for efficiency.  (Current POSIX and Solaris TSS implementations also
...
# if !defined (IOV_MAX) && !defined(SYMBIAN)
#  define IOV_MAX 16
# endif /* IOV_MAX */
...
/* no more using by hjohn 2004.4.14
# if defined (PDL_HAS_WINCE)
...
// Prototypes should come after Basic_Types.h since some types may
...
#   if !defined (PDL_DEFAULT_NAMESPACE_DIR_W)
#     define PDL_DEFAULT_NAMESPACE_DIR_W L"C:\\temp"
#   endif /* PDL_DEFAULT_NAMESPACE_DIR_W */

#   if !defined (PDL_DEFAULT_NAMESPACE_DIR_A)
#     define PDL_DEFAULT_NAMESPACE_DIR_A "C:\\temp"
#   endif /* PDL_DEFAULT_NAMESPACE_DIR_A */
...
// Used for PDL_MMAP_Memory_Pool
#   if !defined (PDL_DEFAULT_BACKING_STORE)
#     define PDL_DEFAULT_BACKING_STORE PDL_TEXT ("C:\\temp\\pdl-malloc-XXXXXX")
#   endif /* PDL_DEFAULT_BACKING_STORE */

// Used for PDL_FILE_Connector
#   if !defined (PDL_DEFAULT_TEMP_FILE)
#     define PDL_DEFAULT_TEMP_FILE PDL_TEXT ("C:\\temp\\pdl-file-XXXXXX")
#   endif /* PDL_DEFAULT_TEMP_FILE */

// Used for logging
#   if !defined (PDL_DEFAULT_LOGFILE)
#     define PDL_DEFAULT_LOGFILE "C:\\temp\\logfile"
#   endif /* PDL_DEFAULT_LOGFILE */
...
#   define PDL_INVALID_SOCKET INVALID_SOCKET
...
/* BUG-17858 : Windows에서 컴파일에러 발생합니다.
 *
 * WINDOWS에서는 LoadLibrary할때 어떤 Flag도 사용하지 않지만
 * UNIX의 dlopen은 다음과 같은 flag를 인자로 받습니다.
 * RTLD_LAZY, RTLD_NOW, RTLD_LOCAL, RTLD_GLOBAL
 * 하여 Windows에서는 이값을 정의만 하여 compile error가
 * 나는 것을 막았습니다.
 */
#   if !defined(RTLD_NOW)
#     define RTLD_NOW 2
...
#   if defined(ITRON)
      /* empty */
#   else
#   if !defined (PDL_LACKS_TCP_H) && !defined(SYMBIAN)
#     include /**/ <netinet/tcp.h>
...
#     include /**/ <sys/uio.h>
#     include /**/ <sys/ipc.h>
#     include /**/ "qnx/qnxSem.h" // hjohn modify
#     include /**/ "qnx/qnxShm.h" // hjohn appended
#     include /**/ <sys/time.h>
#     include /**/ <sys/resource.h>
#     include /**/ <sys/wait.h>
#     include /**/ <pwd.h>
...
#     if defined (__QNX__) || defined(AIX) || defined(ANDROID)
#       include /**/ <termios.h>
#     else  /* ! __QNX__ */
...
#   define O_DIRECT   0x2000 /* direct disk access -- hjohn add */
...
# if !defined (GETVAL) && !defined (USE_WIN32IPC_DAEMON)
#   define GETVAL 0
# endif /* GETVAL */
...
# if !defined (SETVAL) && !defined (USE_WIN32IPC_DAEMON)
#   define SETVAL 0
# endif /* SETVAL */

# if !defined (GETALL) && !defined (USE_WIN32IPC_DAEMON)
#   define GETALL 0
# endif /* GETALL */

# if !defined (SETALL) && !defined (USE_WIN32IPC_DAEMON)
#   define SETALL 0
# endif /* SETALL */

# if !defined (SEM_UNDO) && !defined (USE_WIN32IPC_DAEMON)
#   define SEM_UNDO 0
# endif /* SEM_UNDO */
...
#     define X_OK    00
#   else
#     define X_OK    00      /* Test for eXecute permission. */
#  endif 
# endif /* X_OK */
...
struct flock
{
  ...
  short l_whence;
  PDL_OFF_T l_start;
  PDL_OFF_T l_len;          /* len == 0 means until end of file */
  long  l_sysid;
  pid_t l_pid;
...
extern "C" PDL_Export PDL_THR_FUNC_RETURN pdl_thread_adapter (void *args);
#endif /* PDL_PSOS */
...
# endif /* PDL_HAS_WIN32_STRUCTURAL_EXCEPTIONS */
  ...
  PDL_THR_FUNC_RETURN invoke (void);
...
# if defined (PDL_WIN32) && !defined(PDL_HAS_WINCE)
 ...
 # if (_MSC_VER <= 1200)  && !defined( COMPILE_64BIT )
  ...
  # else
     typedef struct __stat64 PDL_stat;
  # endif
# else
    typedef struct stat PDL_stat;
# endif /* PDL_WIN32 */
...
public:
# if defined (DEBUG)
  static int bDaemonPritable;
# endif /* DEBUG */

  virtual ~PDL_OS(){} /* virtual destructor for base class */
...
#   endif /* fdopen */
  ...
  static int ftruncate (PDL_HANDLE,
                        PDL_OFF_T);
  static int fallocate(PDL_HANDLE, 
                       int, 
                       PDL_OFF_T, 
                       PDL_OFF_T);
  ...
  /*
   * PROJ-2595
   * New interface - fchmod
   */
  static int fchmod(int, mode_t);
...
# endif /* PDL_WIN32 */
  ...
  /* BUG-37596 */
  static pid_t fork_exec_close (ASYS_TCHAR *argv[]);

  // Forks and exec's a process in a manner that works on Solaris and
  // NT.  argv[0] must be the full path name to the executable.

  static int isParentAlive(pid_t aPPID);
...
# endif /* PDL_HAS_MOSTLY_UNICODE_APIS */
  ...
  static void *mmap (void *addr,
                     ...
                     PDL_HANDLE handle,
                     PDL_OFF_T off = 0,
                     const ASYS_TCHAR *file_mapping_name = 0,
  ...
  static PDL_OFF_T filesize (LPCTSTR handle);
  ...
  static int getpmsg (PDL_HANDLE handle,
                      ...
                      *data,
                      int *band,
                      int *flags);
  static int ioctl (PDL_SOCKET handle,
                    int cmd,
                    void * = 0);
  // UNIX-style <ioctl>.
  static int ioctl (PDL_SOCKET socket,
  ...
  static PDL_OFF_T lseek (PDL_HANDLE handle,
                      PDL_OFF_T offset,
                      int whence);
#if defined (PDL_HAS_LLSEEK) || defined (PDL_HAS_LSEEK64)
  ...
  static ssize_t pread (PDL_HANDLE handle,
                        ...
                        size_t nbyte,
                        PDL_OFF_T offset);
  static int recvmsg (PDL_SOCKET handle,
                      struct msghdr *msg,
                      int flags);
  static int sendmsg (PDL_SOCKET handle,
  ...
  static ssize_t preadv (PDL_HANDLE handle,
                         const iovec *iov,
                         int iovlen,
                         PDL_OFF_T offset);
  static ssize_t pwritev (PDL_HANDLE handle,
                          const iovec *iov,
                          int iovcnt,
                          PDL_OFF_T offset);
#endif
  static ssize_t recvv (PDL_SOCKET handle,
                        iovec *iov,
                        int iovlen);
  static ssize_t sendv (PDL_SOCKET handle,
                        const iovec *iov,
                        int iovcnt);
  ...
  static int epoll_create (int aSize);
  ...
  static char *getcwd (char *,
                       size_t);
  static char *realpath (const char *file_name,
                         char *resolved_name);
# if !defined (PDL_HAS_MOSTLY_UNICODE_APIS)
...
# endif /* PDL_HAS_MOSTLY_UNICODE_APIS */
  ...
  static void *shmat (PDL_HANDLE int_id,
                      void *shmaddr,
                      int shmflg);
  static int shmctl (PDL_HANDLE int_id,
                     int cmd,
                     struct shmid_ds *buf);
  static int shmdt (void *shmaddr);
  static PDL_HANDLE shmget (key_t key,
                            size_t size,
                            int flags);
...
typedef struct stack_t
{
...
#endif
  static int sigaltstack(const stack_t *ss, stack_t *oss);
  ...
  static PDL_SOCKET accept (PDL_SOCKET handle,
                            struct sockaddr *addr,
                            int *addrlen);

  static int bind (PDL_SOCKET s,
                   struct sockaddr *name,
                   int namelen);
  static int connect (PDL_SOCKET handle,
                      struct sockaddr *addr,
                      int addrlen);
  ...
  static bool in6_is_addr_unspecified (void *addr);

  static bool in6_is_addr_loopback (void *addr);


  static bool in6_is_addr_multicast (void *addr);


  static bool in6_is_addr_linklocal (void *addr);


  static bool in6_is_addr_sitelocal (void *addr);


  static bool in6_is_addr_v4mapped (void *addr);


  static bool in6_is_addr_v4compat(void *addr);


  static bool in6_is_addr_mc_nodelocal(void *addr);


  static bool in6_is_addr_mc_linklocal(void *addr);


  static bool in6_is_addr_mc_sitelocal(void *addr);


  static bool in6_is_addr_mc_orglocal(void *addr);


  static bool in6_is_addr_mc_global(void *addr);
  ...
  static int closesocket (PDL_SOCKET s);
  ...
  static struct hostent *gethostbyname_r (const char *name,
                                          ...
                                          PDL_HOSTENT_DATA buffer,
                                          int *h_errnop);
  static int getpeername (PDL_SOCKET handle,
                          struct sockaddr *addr,
                          int *addrlen);
  ...
  static int getsockname (PDL_SOCKET handle,
                          struct sockaddr *addr,
                          int *addrlen);
  static int getsockopt (PDL_SOCKET handle,
                         int level,
                         int optname,
                         char *optval,
                         int *optlen);
 ...
 */
  ...
  static int listen (PDL_SOCKET handle,
                     int backlog);
  static int recv (PDL_SOCKET handle,
                   char *buf,
                   int len,
                   int flags = 0);
  static int recvfrom (PDL_SOCKET handle,
                       char *buf,
                       int len,
                       int flags,
                       struct sockaddr *addr,
  ...
  static int recvfrom (PDL_SOCKET handle,
                       ...
                       PDL_OVERLAPPED *overlapped,
                       PDL_OVERLAPPED_COMPLETION_FUNC func);
  static int send (PDL_SOCKET handle,
                   const char *buf,
                   int len,
                   int flags = 0);
  static int sendto (PDL_SOCKET handle,
                     const char *buf,
                     int len,
                     int flags,
  ...
  static int sendto (PDL_SOCKET handle,
                     ...
                     PDL_OVERLAPPED *overlapped,
                     PDL_OVERLAPPED_COMPLETION_FUNC func);
  static int setsockopt (PDL_SOCKET handle,
                         int level,
                         int optname,
                         const char *optval,
                         int optlen);
  // QoS-enabled <ioctl> wrapper.
  static int shutdown (PDL_SOCKET handle,
                       int how);
  static PDL_SOCKET socket (int protocol_family,
                            int type,
                            int proto);
  ...
  static double strtod (const char *s,
                        char **endptr);
  static double strtod_simple(const char *s,
                              char **endptr);
...
#   if defined (PDL_WIN32)
  ...
  static int remove (const wchar_t *path);
#if defined(PDL_HAS_WINCE)

  static int rename (const char *oldname,
                     const char *newname);
  static int unlink (const char *path);
  static int remove (const char *path);
#endif /* PDL_HAS_WINCE */
...
# endif /* PDL_HAS_UNICODE */
  ...
  static int thr_equal (PDL_thread_t t1,
                        PDL_thread_t t2);
  static void thr_exit (PDL_THR_FUNC_RETURN status = 0);
...
# if defined (PDL_WIN32)
#   if defined (PDL_HAS_WINCE)
  static const char *day_of_week_name[7];
...
# endif /* PDL_MT_SAFE */
  ...
  static PDL_SEH_EXCEPT_HANDLER seh_except_selector (void);
  static PDL_SEH_EXCEPT_HANDLER seh_except_selector (PDL_SEH_EXCEPT_HANDLER);

  static PDL_SEH_EXCEPT_HANDLER seh_except_handler (void);
  static PDL_SEH_EXCEPT_HANDLER seh_except_handler (PDL_SEH_EXCEPT_HANDLER);
#endif /* PDL_HAS_WIN32_STRUCTURAL_EXCEPTIONS */
...
private:
  ...
  friend class ideInitializerMtClient;
  friend class PDL_OS;
...
extern "C" ssize_t recv_timedwait (PDL_SOCKET handle,
                                   char *buf,
                                   int len,
                                   int flags,
...
extern "C" ssize_t read_timedwait (PDL_HANDLE handle,
                                   ...
                                   size_t n,
                                   struct timespec *timeout);
extern "C" ssize_t recvmsg_timedwait (PDL_SOCKET handle,
                                      struct msghdr *msg,
                                      int flags,
                                      struct timespec *timeout);
extern "C" ssize_t recvfrom_timedwait (PDL_SOCKET handle,
                                       char *buf,
                                       int len,
                                       int flags,
                                       struct sockaddr *addr,
...
extern "C" ssize_t readv_timedwait (PDL_HANDLE handle,
                                    ...
                                    int iovcnt,
                                    struct timespec* timeout);
extern "C" ssize_t send_timedwait (PDL_SOCKET handle,
                                   const char *buf,
                                   int len,
                                   int flags,
                                   struct timespec *timeout);
extern "C" ssize_t write_timedwait (PDL_HANDLE handle,
                                    ...
                                    size_t n,
                                    struct timespec *timeout);
extern "C" ssize_t sendmsg_timedwait (PDL_SOCKET handle,
                                      PDL_SENDMSG_TYPE *msg,
                                      int flags,
                                      struct timespec *timeout);
extern "C" ssize_t sendto_timedwait (PDL_SOCKET handle,
                                     const char *buf,
                                     int len,
                                     int flags,
                                     const struct sockaddr *addr,
...
# else   /* ! PDL_HAS_TSS_EMULATION */
#     define PDL_DEFAULT_THREAD_KEYS 1088
...
#   endif /* PDL_SIZEOF_LONG == 8 */
  ...
  // use by this thread.
  u_short key_bit_words_initialized_;
};
...
#   define PDL_NEW_RETURN(POINTER,CONSTRUCTOR,SIZE,RET_VAL) \
   do { POINTER = (CONSTRUCTOR *)PDL_OS::malloc(SIZE); \
     if (POINTER == 0) { errno = ENOMEM; return RET_VAL; } \
   } while (0)
#   define PDL_NEW(POINTER,CONSTRUCTOR, SIZE) \
   do { POINTER = (CONSTRUCTOR *)PDL_OS::malloc(SIZE); \
...
#if defined (PDL_HAS_WINCE_BROKEN_ERRNO)
   PDL_Errno_Guard& operator= (const PDL_ERRNO_TYPE &errno_ref);
...
public:
  ...
  PDL_Wide_To_Ascii (const wchar_t *s);

  /// Dtor will free up the memory.
  ~PDL_Wide_To_Ascii (void);
...
private:
  ...
  PDL_Wide_To_Ascii (void);
  PDL_Wide_To_Ascii (PDL_Wide_To_Ascii &);
  PDL_Wide_To_Ascii& operator= (PDL_Wide_To_Ascii &);
};

/**
 * @class PDL_Ascii_To_Wide
 *
...
public:
  /// Ctor must take a wchar string.
  PDL_Ascii_To_Wide (const char *s);

  /// Dtor will free up the memory.
  ~PDL_Ascii_To_Wide (void);
...
private:
  ...
  /// Disallow these operation.
  PDL_Ascii_To_Wide (void);
  PDL_Ascii_To_Wide (PDL_Ascii_To_Wide &);
  PDL_Ascii_To_Wide operator= (PDL_Ascii_To_Wide &);
};
...
#     define ASYS_ONLY_MULTIBYTE_STRING(WIDE_STRING) \
            PDL_Wide_To_Ascii (WIDE_STRING).char_rep ()
#   else
#     define ASYS_MULTIBYTE_STRING(WIDE_STRING) \
            PDL_Wide_To_Ascii (WIDE_STRING).char_rep ()
#     define ASYS_ONLY_WIDE_STRING(WIDE_STRING) \
            PDL_Ascii_To_Wide (STRING).wchar_rep ()
...
#if defined (PDL_WIN32)
#if defined (PDL_HAS_MOSTLY_UNICODE_APIS)
#define PDL_TEXT_SERVICE_TABLE_ENTRY             SERVICE_TABLE_ENTRYW
#define PDL_TEXT_STARTUPINFO                     STARTUPINFOW
#define PDL_TEXT_WIN32_FIND_DATA                 WIN32_FIND_DATAW

#define PDL_TEXT_CreateEvent                     ::CreateEventW
#define PDL_TEXT_CreateFile                      ::CreateFileW
#define PDL_TEXT_CreateFileMapping               ::CreateFileMappingW
#define PDL_TEXT_CreateMutex                     ::CreateMutexW
#define PDL_TEXT_CreateProcess                   ::CreateProcessW
#define PDL_TEXT_CreateSemaphore                 ::CreateSemaphoreW
#define PDL_TEXT_CreateService                   ::CreateServiceW
#define PDL_TEXT_ExpandEnvironmentStrings        ::ExpandEnvironmentStringsW
#define PDL_TEXT_FindFirstChangeNotification     ::FindFirstChangeNotificationW
#define PDL_TEXT_FindFirstFile                   ::FindFirstFileW
#define PDL_TEXT_FindNextFile                    ::FindNextFileW
#define PDL_TEXT_FormatMessage                   ::FormatMessageW
#define PDL_TEXT_FreeEnvironmentStrings          ::FreeEnvironmentStringsW
#define PDL_TEXT_GetComputerName                 ::GetComputerNameW
#define PDL_TEXT_GetEnvironmentStrings           ::GetEnvironmentStringsW
#define PDL_TEXT_GetFileAttributes               ::GetFileAttributesW
#define PDL_TEXT_GetModuleFileName               ::GetModuleFileNameW
#define PDL_TEXT_GetTempPath                     ::GetTempPathW
#define PDL_TEXT_GetUserName                     ::GetUserNameW
#define PDL_TEXT_LoadLibrary                     ::LoadLibraryW
#define PDL_TEXT_MoveFileEx                      ::MoveFileExW
#define PDL_TEXT_WaitNamedPipe                   ::WaitNamedPipeW
#define PDL_TEXT_OpenFileMapping                 ::OpenFileMappingW
#define PDL_TEXT_OpenSCManager                   ::OpenSCManagerW
#define PDL_TEXT_OpenService                     ::OpenServiceW
#define PDL_TEXT_RegisterEventSource             ::RegisterEventSourceW
#define PDL_TEXT_RegisterServiceCtrlHandler      ::RegisterServiceCtrlHandlerW
#define PDL_TEXT_RegConnectRegistry              ::RegConnectRegistryW
#define PDL_TEXT_RegCreateKeyEx                  ::RegCreateKeyExW
#define PDL_TEXT_RegDeleteKey                    ::RegDeleteKeyW
#define PDL_TEXT_RegDeleteValue                  ::RegDeleteValueW
#define PDL_TEXT_RegEnumKeyEx                    ::RegEnumKeyExW
#define PDL_TEXT_RegEnumValue                    ::RegEnumValueW
#define PDL_TEXT_RegCreateKey                    ::RegCreateKeyW
#define PDL_TEXT_RegOpenKey                      ::RegOpenKeyW
#define PDL_TEXT_RegOpenKeyEx                    ::RegOpenKeyExW
#define PDL_TEXT_RegQueryValueEx                 ::RegQueryValueExW
#define PDL_TEXT_RegSetValueEx                   ::RegSetValueExW
#define PDL_TEXT_ReportEvent                     ::ReportEventW
#define PDL_TEXT_SearchPath                      ::SearchPathW
#define PDL_TEXT_StartService                    ::StartServiceW
#define PDL_TEXT_StartServiceCtrlDispatcher      ::StartServiceCtrlDispatcherW

#else /* PDL_HAS_MOSTLY_UNICODE_APIS */
#define PDL_TEXT_SERVICE_TABLE_ENTRY             SERVICE_TABLE_ENTRYA
#define PDL_TEXT_STARTUPINFO                     STARTUPINFOA
#define PDL_TEXT_WIN32_FIND_DATA                 WIN32_FIND_DATAA

#define PDL_TEXT_CreateEvent                     ::CreateEventA
#define PDL_TEXT_CreateFile                      ::CreateFileA
#define PDL_TEXT_CreateFileMapping               ::CreateFileMappingA
#define PDL_TEXT_CreateMutex                     ::CreateMutexA
#define PDL_TEXT_CreateProcess                   ::CreateProcessA
#define PDL_TEXT_CreateSemaphore                 ::CreateSemaphoreA
#define PDL_TEXT_CreateService                   ::CreateServiceA
#define PDL_TEXT_ExpandEnvironmentStrings        ::ExpandEnvironmentStringsA
#define PDL_TEXT_FindFirstChangeNotification     ::FindFirstChangeNotificationA
#define PDL_TEXT_FindFirstFile                   ::FindFirstFileA
#define PDL_TEXT_FindNextFile                    ::FindNextFileA
#define PDL_TEXT_FormatMessage                   ::FormatMessageA
#define PDL_TEXT_FreeEnvironmentStrings          ::FreeEnvironmentStringsA
#define PDL_TEXT_GetComputerName                 ::GetComputerNameA
#define PDL_TEXT_GetEnvironmentStrings           ::GetEnvironmentStringsA
#define PDL_TEXT_GetFileAttributes               ::GetFileAttributesA
#define PDL_TEXT_GetModuleFileName               ::GetModuleFileNameA
#define PDL_TEXT_GetTempPath                     ::GetTempPathA
#define PDL_TEXT_GetUserName                     ::GetUserNameA
#define PDL_TEXT_LoadLibrary                     ::LoadLibraryA
#define PDL_TEXT_MoveFileEx                      ::MoveFileExA
#define PDL_TEXT_WaitNamedPipe                   ::WaitNamedPipeA
#define PDL_TEXT_OpenFileMapping                 ::OpenFileMappingA
#define PDL_TEXT_OpenSCManager                   ::OpenSCManagerA
#define PDL_TEXT_OpenService                     ::OpenServiceA
#define PDL_TEXT_RegisterEventSource             ::RegisterEventSourceA
#define PDL_TEXT_RegisterServiceCtrlHandler      ::RegisterServiceCtrlHandlerA
#define PDL_TEXT_RegConnectRegistry              ::RegConnectRegistryA
#define PDL_TEXT_RegCreateKeyEx                  ::RegCreateKeyExA
#define PDL_TEXT_RegDeleteKey                    ::RegDeleteKeyA
#define PDL_TEXT_RegDeleteValue                  ::RegDeleteValueA
#define PDL_TEXT_RegEnumKeyEx                    ::RegEnumKeyExA
#define PDL_TEXT_RegEnumValue                    ::RegEnumValueA
#define PDL_TEXT_RegCreateKey                    ::RegCreateKeyA
#define PDL_TEXT_RegOpenKey                      ::RegOpenKeyA
#define PDL_TEXT_RegOpenKeyEx                    ::RegOpenKeyExA
#define PDL_TEXT_RegQueryValueEx                 ::RegQueryValueExA
#define PDL_TEXT_RegSetValueEx                   ::RegSetValueExA
#define PDL_TEXT_ReportEvent                     ::ReportEventA
#define PDL_TEXT_SearchPath                      ::SearchPathA
#define PDL_TEXT_StartService                    ::StartServiceA
#define PDL_TEXT_StartServiceCtrlDispatcher      ::StartServiceCtrlDispatcherA
#endif /* PDL_HAS_MOSTLY_UNICODE_APIS */
#endif /* PDL_WIN32 */
...
#if !defined (PDL_LACKS_MALLOC_H)
# include /**/ <malloc.h>
#endif /* PDL_LACKS_MALLOC_H */
 ...
 *
 * POLL을 지원하지 않는 환경에서 컴파일 에러를 피하기 위해 추가하였으며
 * 실제 사용되지는 않는다.
 */
#if !defined (PDL_HAS_POLL)
 ...
 * EPOLL을 지원하지 않는 환경에서 컴파일 에러를 피하기 위해 추가하였으며
 * 실제 사용되지는 않는다.
 * */
#if !defined (PDL_HAS_EPOLL)
