...
/***********************************************************************
 * $Id: mtxGreaterThan.cpp 84859 2019-02-01 06:07:08Z andrew.shin $
 **********************************************************************/
#include <mtx.h>

extern mtlModule mtlUTF16;

extern mtxModule mtxGreaterThan;

static mtxSerialExecuteFunc mtxGreaterThanGetSerialExecute( UInt aMtd1Type,
                                                      UInt /* aMtd2Type */ );
static IDE_RC mtxGreaterThanBoolean( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanDate( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanSmallint( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanInteger( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanBigint( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanReal( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanDouble( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanFloat( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanNumeric( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanChar( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanVarchar( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanNchar( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanNcharUTF16( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanNvarchar( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanInterval( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanNibble( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanBit( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanVarbit( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanByte( mtxEntry ** aEntry );
static IDE_RC mtxGreaterThanVarbyte( mtxEntry ** aEntry );

mtxModule mtxGreaterThan = {
    MTX_EXECUTOR_ID_GREATER_THAN,
    mtx::calculateNA,
    mtxGreaterThanGetSerialExecute
};
                                                      ...
                                                      UInt /* aMtd2Type */ )
{
    ...
    {
        case MTD_CHAR_ID:
            sFunc = mtxGreaterThanChar;

            break;

        case MTD_NUMERIC_ID:
            sFunc = mtxGreaterThanNumeric;

            break;

        case MTD_INTEGER_ID:
            sFunc = mtxGreaterThanInteger;

            break;

        case MTD_SMALLINT_ID:
            sFunc = mtxGreaterThanSmallint;

            break;

        case MTD_FLOAT_ID:
            sFunc = mtxGreaterThanFloat;

            break;

        case MTD_REAL_ID:
            sFunc = mtxGreaterThanReal;

            break;

        case MTD_DOUBLE_ID:
            sFunc = mtxGreaterThanDouble;

            break;

        case MTD_DATE_ID:
            sFunc = mtxGreaterThanDate;

            break;

        case MTD_VARCHAR_ID:
            sFunc = mtxGreaterThanVarchar;

            break;

        case MTD_INTERVAL_ID:
            sFunc = mtxGreaterThanInterval;

            break;

        case MTD_BOOLEAN_ID:
            sFunc = mtxGreaterThanBoolean;

            break;

        case MTD_BYTE_ID:
            sFunc = mtxGreaterThanByte;

            break;

        case MTD_NIBBLE_ID:
            sFunc = mtxGreaterThanNibble;

            break;

        case MTD_VARBYTE_ID:
            sFunc = mtxGreaterThanVarbyte;

            break;

        case MTD_VARBIT_ID:
            sFunc = mtxGreaterThanVarbit;

            break;

        case MTD_NVARCHAR_ID:
            sFunc = mtxGreaterThanNvarchar;
        ...
        case MTD_NCHAR_ID:
            ...
            {
                sFunc = mtxGreaterThanNcharUTF16;
            }
            else
            {
                sFunc = mtxGreaterThanNchar;
            }

            break;

        case MTD_BIT_ID:
            sFunc = mtxGreaterThanBit;

            break;

        case MTD_BIGINT_ID:
            sFunc = mtxGreaterThanBigint;
