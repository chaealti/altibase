...
static mtcName mtfNumXorFunctionName[1] = {
    { NULL, 6, (void*)"NUMXOR" }
};

static IDE_RC mtfNumXorEstimate( mtcNode     * aNode,
...
IDE_RC mtfNumXorCalculate( mtcNode     * aNode,
                           mtcStack    * aStack,
                           SInt          aRemain,
                           void        * aInfo,
                           mtcTemplate * aTemplate );
...
IDE_RC mtfNumXorEstimate( mtcNode     * aNode,
                          mtcTemplate * aTemplate,
                          mtcStack    * aStack,
                          SInt       /* aRemain */,
                          mtcCallBack * aCallBack )
