...
/***********************************************************************
 * $Id: mtfSqrt.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfSqrtFunctionName[1] = {
    { NULL, 4, (void*)"SQRT" }
};

static IDE_RC mtfSqrtEstimate( mtcNode*     aNode,
...
IDE_RC mtfSqrtCalculate(   mtcNode*     aNode,
                           mtcStack*    aStack,
                           SInt         aRemain,
                           void*        aInfo,
                           mtcTemplate* aTemplate );
...
IDE_RC mtfSqrtEstimate( mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        mtcCallBack* aCallBack )
                         ...
                         mtcTemplate* aTemplate )
{
    ...
    else
    {
        *(mtdDoubleType*)aStack[0].value =
            idlOS::sqrt( *(mtdDoubleType*)aStack[1].value );
