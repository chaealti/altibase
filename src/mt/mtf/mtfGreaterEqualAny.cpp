...
/***********************************************************************
 * $Id: mtfGreaterEqualAny.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfGreaterEqualAnyFunctionName[1] = {
    { NULL, 5, (void*)">=ANY" }
};

static IDE_RC mtfGreaterEqualAnyEstimate( mtcNode*     aNode,
...
mtfModule mtfGreaterEqualAny = {
    ...
    mtfGreaterEqualAnyFunctionName,
    &mtfLessThanAll,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    mtfGreaterEqualAnyEstimate
};

IDE_RC mtfGreaterEqualAnyCalculateSelect( mtcNode *     aNode,
                                          mtcStack *    aStack,
                                          SInt          aRemain,
                                          void *        aInfo,
                                          mtcTemplate * aTemplate );

IDE_RC mtfGreaterEqualAnyCalculateFast( mtcNode *     aNode,
                                        mtcStack *    aStack,
                                        SInt          aRemain,
                                        void *        aInfo,
                                        mtcTemplate * aTemplate );
...
IDE_RC mtfGreaterEqualAnyCalculate( mtcNode*     aNode,
                                    mtcStack*    aStack,
                                    SInt         aRemain,
                                    void*        aInfo,
                                    mtcTemplate* aTemplate );

IDE_RC mtfGreaterEqualAnyCalculateSubquery( mtcNode*     aNode,
                                            mtcStack*    aStack,
                                            SInt         aRemain,
                                            void*        aInfo,
                                            mtcTemplate* aTemplate );
...
static const mtcExecute mtfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfGreaterEqualAnyCalculateSelect,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
static const mtcExecute mtfExecuteSubquery = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfGreaterEqualAnyCalculateSubquery,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfGreaterEqualAnyEstimate( mtcNode*     aNode,
                                   mtcTemplate* aTemplate,
                                   mtcStack*    aStack,
                                   SInt      /* aRemain */,
                                   mtcCallBack* aCallBack )
                                          ...
                                          mtcTemplate * aTemplate )
{
    ...
    sFastCalcFunc   = mtfGreaterEqualAnyCalculateFast;
    sNormalCalcFunc = mtfGreaterEqualAnyCalculate;
...
IDE_RC mtfGreaterEqualAnyCalculateSubquery(
    mtcNode*     aNode,
    mtcStack*    aStack,
    SInt         aRemain,
    void*,
