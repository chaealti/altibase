...
/***********************************************************************
 * $Id: mtfLn.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfLnFunctionName[1] = {
    { NULL, 2, (void*)"LN" }
};

static IDE_RC mtfLnEstimate( mtcNode*     aNode,
...
IDE_RC mtfLnCalculate(     mtcNode*     aNode,
                           mtcStack*    aStack,
                           SInt         aRemain,
                           void*        aInfo,
                           mtcTemplate* aTemplate );
...
IDE_RC mtfLnEstimate( mtcNode*     aNode,
                      mtcTemplate* aTemplate,
                      mtcStack*    aStack,
                      SInt      /* aRemain */,
                      mtcCallBack* aCallBack )
                       ...
                       mtcTemplate* aTemplate )
{
    ...
    else
    {
        *(mtdDoubleType*)aStack[0].value =
            idlOS::log( *(mtdDoubleType*)aStack[1].value );
