...
/*******************************************************************************
* $Id: mtfStddevPop.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
*******************************************************************************/
...
static mtcName mtfStddevPopFunctionName[1] =
{
    { NULL, 10, (void*)"STDDEV_POP" }
};

static IDE_RC mtfStddevPopEstimate( mtcNode*     aNode,
                                    mtcTemplate* aTemplate,
                                    mtcStack*    aStack,
                                    SInt         aRemain,
                                    mtcCallBack* aCallBack );

mtfModule mtfStddevPop =
{
    ...
    mtf::finalizeDefault,
    mtfStddevPopEstimate
};

IDE_RC mtfStddevPopInitialize( mtcNode*     aNode,
                               mtcStack*    aStack,
                               SInt         aRemain,
                               void*        aInfo,
                               mtcTemplate* aTemplate );

IDE_RC mtfStddevPopAggregate( mtcNode*     aNode,
                              mtcStack*    aStack,
                              SInt         aRemain,
                              void*        aInfo,
                              mtcTemplate* aTemplate );

IDE_RC mtfStddevPopMerge( mtcNode*     aNode,
                          mtcStack*    ,
                          SInt         ,
                          void*        aInfo,
                          mtcTemplate* aTemplate );

IDE_RC mtfStddevPopFinalize( mtcNode*     aNode,
                             mtcStack*    aStack,
                             SInt         aRemain,
                             void*        aInfo,
                             mtcTemplate* aTemplate );

IDE_RC mtfStddevPopCalculate( mtcNode*     aNode,
                              mtcStack*    aStack,
                              SInt         aRemain,
                              void*        aInfo,
                              mtcTemplate* aTemplate );
...
{
    mtfStddevPopInitialize,
    mtfStddevPopAggregate,
    mtfStddevPopMerge,
    mtfStddevPopFinalize,
    mtfStddevPopCalculate,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfStddevPopEstimate( mtcNode*     aNode,
                             mtcTemplate* aTemplate,
                             mtcStack*    aStack,
                             SInt,
                             mtcCallBack* aCallBack )
