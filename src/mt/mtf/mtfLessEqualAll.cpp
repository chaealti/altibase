...
/***********************************************************************
 * $Id: mtfLessEqualAll.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfLessEqualAllFunctionName[1] = {
    { NULL, 5, (void*)"<=ALL" }
};

static IDE_RC mtfLessEqualAllEstimate( mtcNode*     aNode,
...
mtfModule mtfLessEqualAll = {
    ...
    mtfLessEqualAllFunctionName,
    &mtfGreaterThanAny,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    mtfLessEqualAllEstimate
};

IDE_RC mtfLessEqualAllCalculateSelect( mtcNode *     aNode,
                                       mtcStack *    aStack,
                                       SInt          aRemain,
                                       void *        aInfo,
                                       mtcTemplate * aTemplate );

IDE_RC mtfLessEqualAllCalculateFast( mtcNode *     aNode,
                                     mtcStack *    aStack,
                                     SInt          aRemain,
                                     void *        aInfo,
                                     mtcTemplate * aTemplate );
...
IDE_RC mtfLessEqualAllCalculate( mtcNode*     aNode,
                                 mtcStack*    aStack,
                                 SInt         aRemain,
                                 void*        aInfo,
                                 mtcTemplate* aTemplate );

IDE_RC mtfLessEqualAllCalculateSubquery( mtcNode*     aNode,
                                         mtcStack*    aStack,
                                         SInt         aRemain,
                                         void*        aInfo,
                                         mtcTemplate* aTemplate );
...
static const mtcExecute mtfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfLessEqualAllCalculateSelect,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
static const mtcExecute mtfExecuteSubquery = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfLessEqualAllCalculateSubquery,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfLessEqualAllEstimate( mtcNode*     aNode,
                                mtcTemplate* aTemplate,
                                mtcStack*    aStack,
                                SInt      /* aRemain */,
                                mtcCallBack* aCallBack )
                                       ...
                                       mtcTemplate * aTemplate )
{
    ...
    sFastCalcFunc   = mtfLessEqualAllCalculateFast;
    sNormalCalcFunc = mtfLessEqualAllCalculate;
