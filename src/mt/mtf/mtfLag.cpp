...
/***********************************************************************
 * $Id: mtfLag.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfLagName[1] = {
    { NULL,  3, ( void * )"LAG" }
};

static IDE_RC mtfLagEstimate( mtcNode     * aNode,
...
IDE_RC mtfLagInitialize( mtcNode     * aNode,
                         mtcStack    * aStack,
                         SInt          aRemain,
                         void        * aInfo,
                         mtcTemplate * aTemplate );

IDE_RC mtfLagAggregate( mtcNode     * aNode,
                        mtcStack    * aStack,
                        SInt          aRemain,
                        void        * aInfo,
                        mtcTemplate * aTemplate );

IDE_RC mtfLagFinalize( mtcNode     * aNode,
                       mtcStack    * aStack,
                       SInt          aRemain,
                       void        * aInfo,
                       mtcTemplate * aTemplate );

IDE_RC mtfLagCalculate( mtcNode     * aNode,
                        mtcStack    * aStack,
                        SInt          aRemain,
                        void        * aInfo,
                        mtcTemplate * aTemplate );
...
IDE_RC mtfLagEstimate( mtcNode     * aNode,
                       mtcTemplate * aTemplate,
                       mtcStack    * aStack,
                       SInt          /* aRemain */,
                       mtcCallBack * aCallBack )
