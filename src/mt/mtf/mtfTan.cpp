...
/***********************************************************************
 * $Id: mtfTan.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfTanFunctionName[1] = {
    { NULL, 3, (void*)"TAN" }
};

static IDE_RC mtfTanEstimate( mtcNode*     aNode,
...
IDE_RC mtfTanCalculate(    mtcNode*     aNode,
                           mtcStack*    aStack,
                           SInt         aRemain,
                           void*        aInfo,
                            mtcTemplate* aTemplate );
...
IDE_RC mtfTanEstimate( mtcNode*     aNode,
                       mtcTemplate* aTemplate,
                       mtcStack*    aStack,
                       SInt      /* aRemain */,
                       mtcCallBack* aCallBack )
                        ...
                        mtcTemplate* aTemplate )
{
    ...
    else
    {
        *(mtdDoubleType*)aStack[0].value =
            idlOS::tan( *(mtdDoubleType*)aStack[1].value );
