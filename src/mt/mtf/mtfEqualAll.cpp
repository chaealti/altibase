...
/***********************************************************************
 * $Id: mtfEqualAll.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfEqualAllFunctionName[1] = {
    { NULL, 4, (void*)"=ALL" }
};

static IDE_RC mtfEqualAllEstimate( mtcNode*     aNode,
...
IDE_RC mtfEqualAllCalculateSelect( mtcNode *     aNode,
                                   mtcStack *    aStack,
                                   SInt          aRemain,
                                   void *        aInfo,
                                   mtcTemplate * aTemplate );

IDE_RC mtfEqualAllCalculateFast( mtcNode *     aNode,
                                 mtcStack *    aStack,
                                 SInt          aRemain,
                                 void *        aInfo,
                                 mtcTemplate * aTemplate );
...
IDE_RC mtfEqualAllCalculate( mtcNode*     aNode,
                             mtcStack*    aStack,
                             SInt         aRemain,
                             void*        aInfo,
                             mtcTemplate* aTemplate );

IDE_RC mtfEqualAllCalculateList( mtcNode*     aNode,
                                 mtcStack*    aStack,
                                 SInt         aRemain,
                                 void*        aInfo,
                                 mtcTemplate* aTemplate );

IDE_RC mtfEqualAllCalculateSubquery( mtcNode*     aNode,
                                     mtcStack*    aStack,
                                     SInt         aRemain,
                                     void*        aInfo,
                                     mtcTemplate* aTemplate );

IDE_RC mtfEqualAllCalculateSubqueryList( mtcNode*     aNode,
                                         mtcStack*    aStack,
                                         SInt         aRemain,
                                         void*        aInfo,
                                         mtcTemplate* aTemplate );
...
static const mtcExecute mtfExecuteSubqueryList = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfEqualAllCalculateSubqueryList,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfEqualAllEstimate( mtcNode*     aNode,
                            mtcTemplate* aTemplate,
                            mtcStack*    aStack,
                            SInt      /* aRemain */,
                            mtcCallBack* aCallBack )
                                   ...
                                   mtcTemplate * aTemplate )
{
    ...
    sFastCalcFunc   = mtfEqualAllCalculateFast;
    sNormalCalcFunc = mtfEqualAllCalculate;
                                   ...
                                   mtcTemplate * aTemplate )
{
    ...
    else
    {
        ...
        if ( sData->mIsNullList[sFirst] == ID_TRUE )
        {
        	sValue = MTD_BOOLEAN_NULL;
        }
        else
                                 ...
                                 mtcTemplate* aTemplate )
{
    ...
    for( sCount2 = 0,
         ...
         sStack1 = (mtcStack*)aStack[1].value,
         sStack2 = (mtcStack*)aStack[2].value;
         sCount2 < sFence2 && sValue != MTD_BOOLEAN_FALSE;
         sCount2++, sNode2 = sNode2->next )
    {
        ...
        sValue = mtf::andMatrix[sValue][sSubValue];
    }
                                     ...
                                     mtcTemplate* aTemplate )
{
    ...
    while( sRowExist == ID_TRUE && sValue != MTD_BOOLEAN_FALSE )
    {
