...
/***********************************************************************
 * $Id: mtfGreaterEqualAll.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfGreaterEqualAllFunctionName[1] = {
    { NULL, 5, (void*)">=ALL" }
};

static IDE_RC mtfGreaterEqualAllEstimate( mtcNode*     aNode,
...
mtfModule mtfGreaterEqualAll = {
    2|MTC_NODE_OPERATOR_GREATER_EQUAL|
    ...
    mtfGreaterEqualAllFunctionName,
    &mtfLessThanAny,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    mtfGreaterEqualAllEstimate
};

IDE_RC mtfGreaterEqualAllCalculateSelect( mtcNode *     aNode,
                                          mtcStack *    aStack,
                                          SInt          aRemain,
                                          void *        aInfo,
                                          mtcTemplate * aTemplate );

IDE_RC mtfGreaterEqualAllCalculateFast( mtcNode *     aNode,
                                        mtcStack *    aStack,
                                        SInt          aRemain,
                                        void *        aInfo,
                                        mtcTemplate * aTemplate );
...
IDE_RC mtfGreaterEqualAllCalculate( mtcNode*     aNode,
                                    mtcStack*    aStack,
                                    SInt         aRemain,
                                    void*        aInfo,
                                    mtcTemplate* aTemplate );

IDE_RC mtfGreaterEqualAllCalculateSubquery( mtcNode*     aNode,
                                            mtcStack*    aStack,
                                            SInt         aRemain,
                                            void*        aInfo,
                                            mtcTemplate* aTemplate );
...
static const mtcExecute mtfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfGreaterEqualAllCalculateSelect,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
static const mtcExecute mtfExecuteSubquery = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfGreaterEqualAllCalculateSubquery,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfGreaterEqualAllEstimate( mtcNode*     aNode,
                                   mtcTemplate* aTemplate,
                                   mtcStack*    aStack,
                                   SInt      /* aRemain */,
                                   mtcCallBack* aCallBack )
                                          ...
                                          mtcTemplate * aTemplate )
{
    ...
    sFastCalcFunc   = mtfGreaterEqualAllCalculateFast;
    sNormalCalcFunc = mtfGreaterEqualAllCalculate;
                                        ...
                                        mtcTemplate * aTemplate )
{
    ...
    else
    {
        ...
        {
            sValueInfo2.column = sStackList[sLast].column;
            sValueInfo2.value  = sStackList[sLast].value;
