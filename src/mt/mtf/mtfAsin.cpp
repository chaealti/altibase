...
/***********************************************************************
 * $Id: mtfAsin.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfAsinFunctionName[1] = {
    { NULL, 4, (void*)"ASIN" }
};

static IDE_RC mtfAsinEstimate( mtcNode*     aNode,
...
IDE_RC mtfAsinCalculate(   mtcNode*     aNode,
                           mtcStack*    aStack,
                           SInt         aRemain,
                           void*        aInfo,
                           mtcTemplate* aTemplate );
...
IDE_RC mtfAsinEstimate( mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        mtcCallBack* aCallBack )
    ...
    else
    {
        ...
        else
        {
            *(mtdDoubleType*)aStack[0].value =
                idlOS::asin( *(mtdDoubleType*)aStack[1].value );
