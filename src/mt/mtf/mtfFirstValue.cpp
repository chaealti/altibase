...
static mtcName mtfFirstValueName[1] = {
    { NULL,  11, ( void * )"FIRST_VALUE" }
};

static IDE_RC mtfFirstValueEstimate( mtcNode     * aNode,
                                     mtcTemplate * aTemplate,
                                     mtcStack    * aStack,
                                     SInt          aRemain,
                                     mtcCallBack * aCallBack );

mtfModule mtfFirstValue = {
    ...
    mtf::finalizeDefault,
    mtfFirstValueEstimate
};

IDE_RC mtfFirstValueInitialize( mtcNode     * aNode,
                                mtcStack    * aStack,
                                SInt          aRemain,
                                void        * aInfo,
                                mtcTemplate * aTemplate );

IDE_RC mtfFirstValueAggregate( mtcNode     * aNode,
                               mtcStack    * aStack,
                               SInt          aRemain,
                               void        * aInfo,
                               mtcTemplate * aTemplate );

IDE_RC mtfFirstValueFinalize( mtcNode     * aNode,
                              mtcStack    * aStack,
                              SInt          aRemain,
                              void        * aInfo,
                              mtcTemplate * aTemplate );

IDE_RC mtfFirstValueCalculate( mtcNode     * aNode,
                               mtcStack    * aStack,
                               SInt          aRemain,
                               void        * aInfo,
                               mtcTemplate * aTemplate );
...
static const mtcExecute mtfExecute = {
    mtfFirstValueInitialize,
    mtfFirstValueAggregate,
    mtf::calculateNA,
    mtfFirstValueFinalize,
    mtfFirstValueCalculate,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfFirstValueEstimate( mtcNode     * aNode,
                              mtcTemplate * aTemplate,
                              mtcStack    * aStack,
                              SInt          /* aRemain */,
                              mtcCallBack * /*aCallBack */)
