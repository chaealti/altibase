...
/***********************************************************************
 * $Id: mtfTanh.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfTanhFunctionName[1] = {
    { NULL, 4, (void*)"TANH" }
};

static IDE_RC mtfTanhEstimate( mtcNode*     aNode,
...
IDE_RC mtfTanhCalculate(   mtcNode*     aNode,
                           mtcStack*    aStack,
                           SInt         aRemain,
                           void*        aInfo,
                           mtcTemplate* aTemplate );
...
IDE_RC mtfTanhEstimate( mtcNode*     aNode,
                        mtcTemplate* aTemplate,
                        mtcStack*    aStack,
                        SInt      /* aRemain */,
                        mtcCallBack* aCallBack )
                         ...
                         mtcTemplate* aTemplate )
{
    ...
    else
    {
        *(mtdDoubleType*)aStack[0].value =
            idlOS::tanh( *(mtdDoubleType*)aStack[1].value );
