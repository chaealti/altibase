...
/***********************************************************************
 * $Id: mtfBitOr.cpp 14592 2005-12-09 01:38:06Z jhseong $
 **********************************************************************/
...
static mtcName mtfBitOrFunctionName[1] = {
    { NULL, 5, (void*)"BITOR" }
};

static IDE_RC mtfBitOrEstimate( mtcNode*     aNode,
...
IDE_RC mtfBitOrCalculate(  mtcNode*     aNode,
                           mtcStack*    aStack,
                           SInt         aRemain,
                           void*        aInfo,
                           mtcTemplate* aTemplate );
...
IDE_RC mtfBitOrEstimate( mtcNode*     aNode,
                         mtcTemplate* aTemplate,
                         mtcStack*    aStack,
                         SInt      /* aRemain */,
                         mtcCallBack* aCallBack )
