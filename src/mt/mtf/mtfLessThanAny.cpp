...
static mtcName mtfLessThanAnyFunctionName[1] = {
    { NULL, 4, (void*)"<ANY" }
};

static IDE_RC mtfLessThanAnyEstimate( mtcNode*     aNode,
...
mtfModule mtfLessThanAny = {
    2|MTC_NODE_OPERATOR_LESS|
    ...
    mtf::finalizeDefault,
    mtfLessThanAnyEstimate
};

IDE_RC mtfLessThanAnyCalculateSelect( mtcNode *     aNode,
                                      mtcStack *    aStack,
                                      SInt          aRemain,
                                      void *        aInfo,
                                      mtcTemplate * aTemplate );

IDE_RC mtfLessThanAnyCalculateFast( mtcNode *     aNode,
                                    mtcStack *    aStack,
                                    SInt          aRemain,
                                    void *        aInfo,
                                    mtcTemplate * aTemplate );
...
IDE_RC mtfLessThanAnyCalculate( mtcNode*     aNode,
                                mtcStack*    aStack,
                                SInt         aRemain,
                                void*        aInfo,
                                mtcTemplate* aTemplate );

IDE_RC mtfLessThanAnyCalculateSubquery( mtcNode*     aNode,
                                        mtcStack*    aStack,
                                        SInt         aRemain,
                                        void*        aInfo,
                                        mtcTemplate* aTemplate );
...
static const mtcExecute mtfExecuteSubquery = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfLessThanAnyCalculateSubquery,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfLessThanAnyEstimate( mtcNode*     aNode,
                               mtcTemplate* aTemplate,
                               mtcStack*    aStack,
                               SInt      /* aRemain */,
                               mtcCallBack* aCallBack )
                                      ...
                                      mtcTemplate * aTemplate )
{
    ...
    sFastCalcFunc   = mtfLessThanAnyCalculateFast;
    sNormalCalcFunc = mtfLessThanAnyCalculate;
