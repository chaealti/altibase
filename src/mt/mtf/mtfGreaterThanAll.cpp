...
/***********************************************************************
 * $Id: mtfGreaterThanAll.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfGreaterThanAllFunctionName[1] = {
    { NULL, 4, (void*)">ALL" }
};

static IDE_RC mtfGreaterThanAllEstimate( mtcNode*     aNode,
...
mtfModule mtfGreaterThanAll = {
    ...
    mtfGreaterThanAllFunctionName,
    &mtfLessEqualAny,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    mtfGreaterThanAllEstimate
};

IDE_RC mtfGreaterThanAllCalculateSelect( mtcNode *     aNode,
                                         mtcStack *    aStack,
                                         SInt          aRemain,
                                         void *        aInfo,
                                         mtcTemplate * aTemplate );

IDE_RC mtfGreaterThanAllCalculateFast( mtcNode *     aNode,
                                       mtcStack *    aStack,
                                       SInt          aRemain,
                                       void *        aInfo,
                                       mtcTemplate * aTemplate );

IDE_RC mtfGreaterThanAllCalculate( mtcNode*     aNode,
                                   mtcStack*    aStack,
                                   SInt         aRemain,
                                   void*        aInfo,
                                   mtcTemplate* aTemplate );

IDE_RC mtfGreaterThanAllCalculateSubquery( mtcNode*     aNode,
                                           mtcStack*    aStack,
                                           SInt         aRemain,
                                           void*        aInfo,
                                           mtcTemplate* aTemplate );
...
static const mtcExecute mtfExecute = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfGreaterThanAllCalculateSelect,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
static const mtcExecute mtfExecuteSubquery = {
    ...
    mtf::calculateNA,
    mtf::calculateNA,
    mtfGreaterThanAllCalculateSubquery,
    NULL,
    mtx::calculateNA,
    mtk::estimateRangeNA,
    mtk::extractRangeNA
...
IDE_RC mtfGreaterThanAllEstimate( mtcNode*     aNode,
                                  mtcTemplate* aTemplate,
                                  mtcStack*    aStack,
                                  SInt      /* aRemain */,
                                  mtcCallBack* aCallBack )
                                         ...
                                         mtcTemplate * aTemplate )
{
    ...
    sFastCalcFunc   = mtfGreaterThanAllCalculateFast;
    sNormalCalcFunc = mtfGreaterThanAllCalculate;
