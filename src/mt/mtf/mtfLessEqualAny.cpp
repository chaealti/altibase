...
/***********************************************************************
 * $Id: mtfLessEqualAny.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
static mtcName mtfLessEqualAnyFunctionName[1] = {
    { NULL, 5, (void*)"<=ANY" }
};

static IDE_RC mtfLessEqualAnyEstimate( mtcNode*     aNode,
...
mtfModule mtfLessEqualAny = {
    2|MTC_NODE_OPERATOR_LESS_EQUAL|
    ...
    mtfLessEqualAnyFunctionName,
    &mtfGreaterThanAll,
    mtf::initializeDefault,
    mtf::finalizeDefault,
    mtfLessEqualAnyEstimate
};

IDE_RC mtfLessEqualAnyCalculateSelect( mtcNode *     aNode,
                                       mtcStack *    aStack,
                                       SInt          aRemain,
                                       void *        aInfo,
                                       mtcTemplate * aTemplate );

IDE_RC mtfLessEqualAnyCalculateFast( mtcNode *     aNode,
                                     mtcStack *    aStack,
                                     SInt          aRemain,
                                     void *        aInfo,
                                     mtcTemplate * aTemplate );

IDE_RC mtfLessEqualAnyCalculate( mtcNode*     aNode,
                                 mtcStack*    aStack,
                                 SInt         aRemain,
                                 void*        aInfo,
                                 mtcTemplate* aTemplate );

IDE_RC mtfLessEqualAnyCalculateSubquery( mtcNode*     aNode,
                                         mtcStack*    aStack,
                                         SInt         aRemain,
                                         void*        aInfo,
                                         mtcTemplate* aTemplate );
...
IDE_RC mtfLessEqualAnyEstimate( mtcNode*     aNode,
                                mtcTemplate* aTemplate,
                                mtcStack*    aStack,
                                SInt      /* aRemain */,
                                mtcCallBack* aCallBack )
                                       ...
                                       mtcTemplate * aTemplate )
{
    ...
    sFastCalcFunc   = mtfLessEqualAnyCalculateFast;
    sNormalCalcFunc = mtfLessEqualAnyCalculate;
                                     ...
                                     mtcTemplate * aTemplate )
{
    ...
    /******************************************/
    /* Compare Only Last RValue (except null) */
    sLast  = sFence - 1;
    ...
    else
    {
        ...
        if ( sData->mIsNullList[sLast] == ID_TRUE )
        {
   			sValue = MTD_BOOLEAN_NULL;
        }
        else
