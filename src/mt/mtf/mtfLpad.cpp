                        ...
                        mtcCallBack* aCallBack )
{
    ...
    // fix BUG-13830
    // 예 : LPAD( 123, 10, '0' ) or LPAD( 123, 10+1, '0' )과 같이
    // length 가 
    // validation단계에서 constant expression이 수행되는 경우는
    // LPAD 의 결과저장컬럼의 precision을 length 길이로 계산한다.
 ...
 ***********************************************************************/
    ...
    else 
    {
        ...
        else
        {
            ...
            // ( 결과 문자열 - source 문자열 ) 만큼 padding 문자를 왼쪽에
 ...
 *    LPAD( char1, n )
 *
 *    aStack[0] : 첫번째 문자열 char1의 왼쪽부터 ' '을 삽입하여
 *                지정한 길이 n만큼의 ' '가 포함된 char1 값
 *    aStack[1] : char1 ( 문자열 )
 *    aStack[2] : n ( 결과 문자열 길이 )
 *
 *    ex) LPAD( 'ab', 5 ) ==> '   ab' 
 *
 ***********************************************************************/
    ...
    else
    {
        ...
        // BUG-25914 : lpad의 길이가 결과노드의 precision을 넘을 수 없다.
 ...
 *    LPAD( char1, n, char2 )
 *
 *    aStack[0] : 첫번째 문자열 char1의 왼쪽부터 char2를 삽입하여
 *                지정한 길이 n만큼의 char2가 포함된 char1 값
 *    aStack[1] : char1 ( 문자열 )
 *    aStack[2] : n ( 결과 문자열 길이 )
 *    aStack[3] : char2 ( Left에 Pad 할 문자열 )
 *
