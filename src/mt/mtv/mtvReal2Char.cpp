...
/***********************************************************************
 * $Id: mtvReal2Char.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
IDE_RC mtvCalculate_Real2Char( mtcNode*     aNode,
                               mtcStack*    aStack,
                               SInt         aRemain,
                               void*        aInfo,
                               mtcTemplate* aTemplate );

mtvModule mtvReal2Char = {
    &mtdChar,
    &mtdReal,
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromRealTo.mGetExecute( mtdChar.id, mtdChar.id );
...
IDE_RC mtvCalculate_Real2Char( mtcNode*,
                               mtcStack*    aStack,
                               SInt,
                               void*,
                               mtcTemplate* )
