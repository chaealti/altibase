...
/***********************************************************************
 * $Id: mtvNumeric2Integer.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
extern mtvModule mtvNumeric2Integer;
...
IDE_RC mtvCalculate_Numeric2Integer( mtcNode*     aNode,
                                     mtcStack*    aStack,
                                     SInt         aRemain,
                                     void*        aInfo,
                                     mtcTemplate* aTemplate );

mtvModule mtvNumeric2Integer = {
    &mtdInteger,
    &mtdNumeric,
    MTV_COST_DEFAULT | MTV_COST_ERROR_PENALTY * 2 | MTV_COST_LOSS_PENALTY,
    mtvEstimate
};
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromNumericTo.mGetExecute( mtdInteger.id, mtdInteger.id );
...
IDE_RC mtvCalculate_Numeric2Integer( mtcNode*,
                                     mtcStack*    aStack,
                                     SInt,
                                     void*,
                                     mtcTemplate* )
