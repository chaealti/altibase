...
/***********************************************************************
 * $Id: mtvFloat2Bigint.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
extern mtvModule mtvFloat2Bigint;
...
IDE_RC mtvCalculate_Float2Bigint( mtcNode*     aNode,
                                  mtcStack*    aStack,
                                  SInt         aRemain,
                                  void*        aInfo,
                                  mtcTemplate* aTemplate );

mtvModule mtvFloat2Bigint = {
    &mtdBigint,
    &mtdFloat,
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromFloatTo.mGetExecute( mtdBigint.id, mtdBigint.id );
...
IDE_RC mtvCalculate_Float2Bigint( mtcNode*,
                                  mtcStack*    aStack,
                                  SInt,
                                  void*,
                                  mtcTemplate* )
