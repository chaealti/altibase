...
/***********************************************************************
 * $Id: mtvNull2Interval.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
IDE_RC mtvCalculate_Null2Interval( mtcNode*     aNode,
                                   mtcStack*    aStack,
                                   SInt         aRemain,
                                   void*        aInfo,
                                   mtcTemplate* aTemplate );

mtvModule mtvNull2Interval = {
    &mtdInterval,
    &mtdNull,
...
IDE_RC mtvCalculate_Null2Interval( mtcNode*,
                                   mtcStack*    aStack,
                                   SInt,
                                   void*,
                                   mtcTemplate* )
