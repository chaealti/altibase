...
/***********************************************************************
 * $Id: mtvSmallint2Float.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
extern mtvModule mtvSmallint2Float;
...
IDE_RC mtvCalculate_Smallint2Float( mtcNode*     aNode,
                                    mtcStack*    aStack,
                                    SInt         aRemain,
                                    void*        aInfo,
                                    mtcTemplate* aTemplate );

mtvModule mtvSmallint2Float = {
    &mtdFloat,
    &mtdSmallint,
    MTV_COST_DEFAULT,
    mtvEstimate
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromSmallintTo.mGetExecute( mtdFloat.id, mtdFloat.id );
...
IDE_RC mtvCalculate_Smallint2Float( mtcNode*,
                                    mtcStack*    aStack,
                                    SInt,
                                    void*,
                                    mtcTemplate* )
