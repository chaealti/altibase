...
/***********************************************************************
 * $Id: mtvInteger2Char.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
extern mtvModule mtvInteger2Char;
...
IDE_RC mtvCalculate_Integer2Char( mtcNode*     aNode,
                                  mtcStack*    aStack,
                                  SInt         aRemain,
                                  void*        aInfo,
                                  mtcTemplate* aTemplate );

mtvModule mtvInteger2Char = {
    &mtdChar,
    &mtdInteger,
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromIntegerTo.mGetExecute( mtdChar.id, mtdChar.id );
...
IDE_RC mtvCalculate_Integer2Char( mtcNode*,
                                  mtcStack*    aStack,
                                  SInt,
                                  void*,
                                  mtcTemplate* )
