...
/***********************************************************************
 * $Id: mtvChar2Nvarchar.cpp 26126 2008-05-23 07:21:56Z copyrei $
 **********************************************************************/
...
extern mtvModule mtvChar2Nvarchar;
...
IDE_RC mtvCalculate_Char2Nvarchar( mtcNode*     aNode,
                                   mtcStack*    aStack,
                                   SInt         aRemain,
                                   void*        aInfo,
                                   mtcTemplate* aTemplate );

mtvModule mtvChar2Nvarchar = {
    &mtdNvarchar,
    &mtdChar,
    MTV_COST_DEFAULT,
    mtvEstimate
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromCharTo.mGetExecute( mtdNvarchar.id, mtdNvarchar.id );
...
IDE_RC mtvCalculate_Char2Nvarchar( mtcNode*,
                                   mtcStack*    aStack,
                                   SInt,
                                   void*,
                                   mtcTemplate* )
