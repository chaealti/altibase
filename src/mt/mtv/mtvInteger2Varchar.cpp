...
/***********************************************************************
 * $Id: mtvInteger2Varchar.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
extern mtvModule mtvInteger2Varchar;
...
IDE_RC mtvCalculate_Integer2Varchar( mtcNode*     aNode,
                                     mtcStack*    aStack,
                                     SInt         aRemain,
                                     void*        aInfo,
                                     mtcTemplate* aTemplate );

mtvModule mtvInteger2Varchar = {
    &mtdVarchar,
    &mtdInteger,
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromIntegerTo.mGetExecute( mtdVarchar.id, mtdVarchar.id );
...
IDE_RC mtvCalculate_Integer2Varchar( mtcNode*,
                                     mtcStack*    aStack,
                                     SInt,
                                     void*,
                                     mtcTemplate* )
