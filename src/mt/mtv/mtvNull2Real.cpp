...
/***********************************************************************
 * $Id: mtvNull2Real.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
IDE_RC mtvCalculate_Null2Real( mtcNode*     aNode,
                               mtcStack*    aStack,
                               SInt         aRemain,
                               void*        aInfo,
                               mtcTemplate* aTemplate );

mtvModule mtvNull2Real = {
    &mtdReal,
    &mtdNull,
...
IDE_RC mtvCalculate_Null2Real( mtcNode*,
                               mtcStack*    aStack,
                               SInt,
                               void*,
                               mtcTemplate* )
