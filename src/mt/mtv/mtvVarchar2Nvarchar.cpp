...
/***********************************************************************
 * $Id: mtvVarchar2Nvarchar.cpp 26126 2008-05-23 07:21:56Z copyrei $
 **********************************************************************/
...
IDE_RC mtvCalculate_Varchar2Nvarchar( mtcNode*     aNode,
                                      mtcStack*    aStack,
                                      SInt         aRemain,
                                      void*        aInfo,
                                      mtcTemplate* aTemplate );

mtvModule mtvVarchar2Nvarchar = {
    &mtdNvarchar,
    &mtdVarchar,
    MTV_COST_DEFAULT,
    mtvEstimate
...
IDE_RC mtvCalculate_Varchar2Nvarchar( mtcNode*,
                                mtcStack*    aStack,
                                SInt,
                                void*,
                                mtcTemplate* )
