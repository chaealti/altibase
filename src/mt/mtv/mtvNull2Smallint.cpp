...
/***********************************************************************
 * $Id: mtvNull2Smallint.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
IDE_RC mtvCalculate_Null2Smallint( mtcNode*     aNode,
                                   mtcStack*    aStack,
                                   SInt         aRemain,
                                   void*        aInfo,
                                   mtcTemplate* aTemplate );

mtvModule mtvNull2Smallint = {
    &mtdSmallint,
    &mtdNull,
...
IDE_RC mtvCalculate_Null2Smallint( mtcNode*,
                                   mtcStack*    aStack,
                                   SInt,
                                   void*,
                                   mtcTemplate* )
