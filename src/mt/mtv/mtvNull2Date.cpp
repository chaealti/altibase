...
/***********************************************************************
 * $Id: mtvNull2Date.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
IDE_RC mtvCalculate_Null2Date( mtcNode*     aNode,
                               mtcStack*    aStack,
                               SInt         aRemain,
                               void*        aInfo,
                               mtcTemplate* aTemplate );

mtvModule mtvNull2Date = {
    &mtdDate,
    &mtdNull,
...
IDE_RC mtvCalculate_Null2Date( mtcNode*,
                               mtcStack*    aStack,
                               SInt,
                               void*,
                               mtcTemplate* )
