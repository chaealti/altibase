...
/***********************************************************************
 * $Id: mtvFloat2Integer.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
extern mtvModule mtvFloat2Integer;
...
IDE_RC mtvCalculate_Float2Integer( mtcNode*     aNode,
                                    mtcStack*    aStack,
                                    SInt         aRemain,
                                    void*        aInfo,
                                    mtcTemplate* aTemplate );

mtvModule mtvFloat2Integer = {
    &mtdInteger,
    &mtdFloat,
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromFloatTo.mGetExecute( mtdInteger.id, mtdInteger.id );
...
IDE_RC mtvCalculate_Float2Integer( mtcNode*,
                                  mtcStack*    aStack,
                                  SInt,
                                  void*,
                                  mtcTemplate* )
