...
/***********************************************************************
 * $Id: mtvNumeric2Varchar.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
extern mtvModule mtvNumeric2Varchar;
...
IDE_RC mtvCalculate_Numeric2Varchar( mtcNode*     aNode,
                                     mtcStack*    aStack,
                                     SInt         aRemain,
                                     void*        aInfo,
                                     mtcTemplate* aTemplate );

mtvModule mtvNumeric2Varchar = {
    &mtdVarchar,
    &mtdNumeric,
...
IDE_RC mtvCalculate_Numeric2Varchar( mtcNode*,
                                     mtcStack*    aStack,
                                     SInt,
                                     void*,
                                     mtcTemplate* )
{
    ...
    // 1(부호) + 40(precision) + 1(.) + 1(E) + 1(exponent부호) + 3(exponent값)
    // = 47이 된다.
    IDE_TEST( mtv::float2String( sVarchar->value, 47, &sLength, sNumeric )
              != IDE_SUCCESS );
