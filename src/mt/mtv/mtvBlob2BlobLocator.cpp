...
/***********************************************************************
 * $Id: mtvBlob2BlobLocator.cpp 13146 2005-08-12 09:20:06Z sungminee $
 **********************************************************************/
...
IDE_RC mtvCalculate_Blob2BlobLocator( mtcNode*     aNode,
                                    mtcStack*    aStack,
                                    SInt         aRemain,
                                    void*        aInfo,
                                    mtcTemplate* aTemplate );

mtvModule mtvBlob2BlobLocator = {
    &mtdBlobLocator,
    &mtdBlob,
    MTV_COST_DEFAULT,
    mtvEstimate
                                      ...
                                      mtcTemplate* aTemplate )
{
    ...
    else
    {
        ...
        IDE_ASSERT_MSG( sOrgLobColumn->module->id == MTD_BLOB_ID,
