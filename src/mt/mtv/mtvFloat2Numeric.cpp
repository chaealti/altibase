...
/***********************************************************************
 * $Id: mtvFloat2Numeric.cpp 85090 2019-03-28 01:15:28Z andrew.shin $
 **********************************************************************/
...
IDE_RC mtvCalculate_Float2Numeric( mtcNode*     aNode,
                                   mtcStack*    aStack,
                                   SInt         aRemain,
                                   void*        aInfo,
                                   mtcTemplate* aTemplate );

mtvModule mtvFloat2Numeric = {
    &mtdNumeric,
    &mtdFloat,
    MTV_COST_DEFAULT,
    mtvEstimate
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromFloatTo.mGetExecute( mtdNumeric.id, mtdNumeric.id );
...
IDE_RC mtvCalculate_Float2Numeric( mtcNode*,
                                   mtcStack*    aStack,
                                   SInt,
                                   void*,
                                   mtcTemplate* )
