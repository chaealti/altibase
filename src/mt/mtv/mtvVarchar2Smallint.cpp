...
/***********************************************************************
 * $Id: mtvVarchar2Smallint.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
extern mtvModule mtvVarchar2Smallint;
...
IDE_RC mtvCalculate_Varchar2Smallint( mtcNode*     aNode,
                                      mtcStack*    aStack,
                                      SInt         aRemain,
                                      void*        aInfo,
                                      mtcTemplate* aTemplate );

mtvModule mtvVarchar2Smallint = {
    &mtdSmallint,
    &mtdVarchar,
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromVarcharTo.mGetExecute( mtdSmallint.id, mtdSmallint.id );
...
IDE_RC mtvCalculate_Varchar2Smallint( mtcNode*,
                                      mtcStack*    aStack,
                                      SInt,
                                      void*,
                                      mtcTemplate* )
