...
/***********************************************************************
 * $Id: mtvFloat2Double.cpp 84991 2019-03-11 09:21:00Z andrew.shin $
 **********************************************************************/
...
IDE_RC mtvCalculate_Float2Double( mtcNode*     aNode,
                                  mtcStack*    aStack,
                                  SInt         aRemain,
                                  void*        aInfo,
                                  mtcTemplate* aTemplate );

mtvModule mtvFloat2Double = {
    &mtdDouble,
    &mtdFloat,
                           ...
                           mtcCallBack* )
{
    ...
    aTemplate->rows[aNode->table].execute[aNode->column].mSerialExecute
        = mtxFromFloatTo.mGetExecute( mtdDouble.id, mtdDouble.id );
...
IDE_RC mtvCalculate_Float2Double( mtcNode*,
                                  mtcStack*    aStack,
                                  SInt,
                                  void*,
                                  mtcTemplate* )
{
    ...
    else
    {
        ...
        mtc::numeric2Double( sDouble, sFloat );
