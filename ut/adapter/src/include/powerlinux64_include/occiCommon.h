...
/* 
   ...
   MODIFIED   (MM/DD/YY)
   dnutakki    05/19/15 - Lop LE change
   vlakkund    02/14/11 - Bug 11742582 : include <cstring> when g++ 4.3 is used
   suram       01/10/05 - bug 3993485 
   suram       01/10/05 - bug 3993485 
...
#ifndef ORACSTRINGSTL
#define ORACSTRINGSTL
#include <cstring>
#endif
#endif
...
#if (__GNUC__ == 3 && __GNUC_MINOR__ == 2) || defined(LINUX_PPC64) || defined(LINUX_PPC64LE)
